...
func (_q *UserQuery) OnlyIDX(ctx context.Context) uint64 { return entbuilder.Must(_q.OnlyID(ctx)) }
...
func (_q *UserQuery) IDsX(ctx context.Context) []uint64 { return entbuilder.Must(_q.IDs(ctx)) }

...
var taskDeleteDescriptor = entbuilder.DeleteDescriptor[config, *TaskMutation]{
	Table: task.Table,
...
func (_d *TaskDelete) sqlExec(ctx context.Context) (int, error) {
	_spec, err := entbuilder.BuildDeleteSpec(_d.config, _d.mutation, &taskDeleteDescriptor)
	if err != nil {
		return 0, err
	}

...
func (_q *TaskQuery) StoreEager(name string, loader func(context.Context, []*Task) error) *TaskQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Task) error)
	}
...
func (_q *TaskQuery) EagerLoaders() map[string]func(context.Context, []*Task) error {
...
func (_q *TaskQuery) Order(o ...OrderOption) *TaskQuery {
...
func (_q *TaskQuery) First(ctx context.Context) (*Task, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Task, []*Task](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Task, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *TaskQuery) Only(ctx context.Context) (*Task, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Task, []*Task](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Task, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *TaskQuery) All(ctx context.Context) ([]*Task, error) {
	return entbuilder.RunAll[[]*Task](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Task, error) { return _q.sqlAll(ctx) })
}
...
func (_q *TaskQuery) Clone() *TaskQuery {
	...
	return &TaskQuery{
		...
		eagerLoaders: cloneEagerLoadersTask(_q.eagerLoaders),
	}
}
...
// dispatch loop.
func (_q *TaskQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Task, error) {
	var (
		nodes       = []*Task{}
		withFKs     = _q.withFKs
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
			_q.eagerLoaders["teams"] != nil,
...
func (_q *TaskQuery) IncludeForeignKeys(b bool) *TaskQuery {
	_q.withFKs = b
	return _q
}
...
func (_g *TaskGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*TaskQuery, *TaskGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *TaskSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*TaskQuery, *TaskSelect](ctx, _s.TaskQuery, _s, _s.QueryState.Inters, v)
}
...
// cloneEagerLoadersTask returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersTask(in map[string]func(context.Context, []*Task) error) map[string]func(context.Context, []*Task) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Task) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

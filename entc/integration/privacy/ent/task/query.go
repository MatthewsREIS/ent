...
func (_q *TaskQuery) All(ctx context.Context) ([]*Task, error) {
	nodes, err := entbuilder.RunAll[[]*Task](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Task, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

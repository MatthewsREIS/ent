...
func (_q *TaskQuery) Limit(limit int) *TaskQuery { _q.ctx.Limit = &limit; return _q }

// Offset to start from.
func (_q *TaskQuery) Offset(offset int) *TaskQuery { _q.ctx.Offset = &offset; return _q }

// Unique configures the query builder to filter duplicate records on query.
// By default, unique is set to true, and can be disabled using this method.
func (_q *TaskQuery) Unique(unique bool) *TaskQuery { _q.ctx.Unique = &unique; return _q }
...
func (_q *TaskQuery) Only(ctx context.Context) (*Task, error) {
	...
	case 0:
		return nil, &NotFoundError{Label: task.Label}
	default:
		return nil, &NotSingularError{Label: task.Label}
	}
}

// OnlyX is like Only, but panics if an error occurs.
func (_q *TaskQuery) OnlyX(ctx context.Context) *Task { return entbuilder.Must(_q.Only(ctx)) }
...
func (_q *TaskQuery) OnlyIDX(ctx context.Context) int { return entbuilder.Must(_q.OnlyID(ctx)) }
...
func (_q *TaskQuery) AllX(ctx context.Context) []*Task { return entbuilder.Must(_q.All(ctx)) }
...
func (_q *TaskQuery) IDsX(ctx context.Context) []int { return entbuilder.Must(_q.IDs(ctx)) }
...
func (_q *TaskQuery) CountX(ctx context.Context) int { return entbuilder.Must(_q.Count(ctx)) }
...
func (_q *TaskQuery) ExistX(ctx context.Context) bool { return entbuilder.Must(_q.Exist(ctx)) }

...
func (_q *TeamQuery) loadTasks(ctx context.Context, query *TaskQuery, nodes []*Team, init func(*Team), assign func(*Team, *Task)) error {
	return entbuilder.LoadEdgeM2M(ctx, &teamTasksEdgeLoadDescriptor, nodes, init, assign, [2]int{1, 0},
		func(fn func(*sql.Selector)) { query.Where(fn) },
		query.prepareQuery,
		func(ctx context.Context, modifiers ...func(context.Context, *sqlgraph.QuerySpec)) ([]*Task, error) {
...
func (_q *TeamQuery) loadUsers(ctx context.Context, query *UserQuery, nodes []*Team, init func(*Team), assign func(*Team, *User)) error {
	return entbuilder.LoadEdgeM2M(ctx, &teamUsersEdgeLoadDescriptor, nodes, init, assign, [2]int{1, 0},
		func(fn func(*sql.Selector)) { query.Where(fn) },
		query.prepareQuery,

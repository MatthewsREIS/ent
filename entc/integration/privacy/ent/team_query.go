...
func (_q *TeamQuery) Limit(limit int) *TeamQuery { _q.ctx.Limit = &limit; return _q }

// Offset to start from.
func (_q *TeamQuery) Offset(offset int) *TeamQuery { _q.ctx.Offset = &offset; return _q }

// Unique configures the query builder to filter duplicate records on query.
// By default, unique is set to true, and can be disabled using this method.
func (_q *TeamQuery) Unique(unique bool) *TeamQuery { _q.ctx.Unique = &unique; return _q }
...
func (_q *TeamQuery) OnlyX(ctx context.Context) *Team { return entbuilder.Must(_q.Only(ctx)) }
...
func (_q *TeamQuery) OnlyIDX(ctx context.Context) int { return entbuilder.Must(_q.OnlyID(ctx)) }
...
func (_q *TeamQuery) AllX(ctx context.Context) []*Team { return entbuilder.Must(_q.All(ctx)) }
...
func (_q *TeamQuery) IDsX(ctx context.Context) []int { return entbuilder.Must(_q.IDs(ctx)) }
...
func (_q *TeamQuery) CountX(ctx context.Context) int { return entbuilder.Must(_q.Count(ctx)) }
...
func (_q *TeamQuery) ExistX(ctx context.Context) bool { return entbuilder.Must(_q.Exist(ctx)) }

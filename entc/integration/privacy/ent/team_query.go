...
func (_q *TeamQuery) First(ctx context.Context) (*Team, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Team, []*Team](ctx, _q, _q.Ctx, ent.OpQueryFirst, team.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Team, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *TeamQuery) Only(ctx context.Context) (*Team, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Team, []*Team](ctx, _q, _q.Ctx, ent.OpQueryOnly, team.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Team, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}

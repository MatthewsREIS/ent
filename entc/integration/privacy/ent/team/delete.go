...
func (_d *TeamDelete) Where(ps ...predicate.Team) *TeamDelete { _d.mutation.Where(ps...); return _d }
...
func (_d *TeamDelete) ExecX(ctx context.Context) int { return entbuilder.Must(_d.Exec(ctx)) }

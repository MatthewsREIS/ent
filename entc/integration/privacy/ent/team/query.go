...
func (_q *TeamQuery) All(ctx context.Context) ([]*Team, error) {
	nodes, err := entbuilder.RunAll[[]*Team](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Team, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

...
type TeamQuery struct {
	Config
	entbuilder.QueryState[predicate.Team]
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Team) error
}
...
func (_q *TeamQuery) StoreEager(name string, loader func(context.Context, []*Team) error) *TeamQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Team) error)
	}
...
func (_q *TeamQuery) EagerLoaders() map[string]func(context.Context, []*Team) error {
...
func (_q *TeamQuery) Order(o ...OrderOption) *TeamQuery {
...
func (_q *TeamQuery) First(ctx context.Context) (*Team, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Team, []*Team](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Team, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *TeamQuery) Only(ctx context.Context) (*Team, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Team, []*Team](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Team, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *TeamQuery) All(ctx context.Context) ([]*Team, error) {
	return entbuilder.RunAll[[]*Team](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Team, error) { return _q.sqlAll(ctx) })
}
...
func (_q *TeamQuery) Clone() *TeamQuery {
	...
	return &TeamQuery{
		...
		eagerLoaders: cloneEagerLoadersTeam(_q.eagerLoaders),
	}
}
...
// dispatch loop.
func (_q *TeamQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Team, error) {
	var (
		nodes       = []*Team{}
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
			_q.eagerLoaders["tasks"] != nil,
...
func (_q *TeamQuery) IncludeForeignKeys(bool) *TeamQuery {
	return _q
}
...
func (_g *TeamGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*TeamQuery, *TeamGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *TeamSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*TeamQuery, *TeamSelect](ctx, _s.TeamQuery, _s, _s.QueryState.Inters, v)
}
...
// teamCreateDescriptor holds the metadata and callbacks for constructing a Team entity.
var teamCreateDescriptor = &entbuilder.CreateDescriptor[Config, Team, *TeamMutation]{
	Table:   Table,
	NewNode: func(c Config) *Team { return &Team{Config: c} },
	ID: &entbuilder.IDDescriptor[Config, Team, *TeamMutation]{
		Column:      FieldID,
		Type:        field.TypeInt,
		UserDefined: false,
		AssignGenerated: func(n *Team, v driver.Value) error {
			id, ok := v.(int64)
			if !ok {
				return fmt.Errorf("unexpected Team.ID type: %T", v)
			}
			n.ID = int(id)
			return nil
		},
...
// cloneEagerLoadersTeam returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersTeam(in map[string]func(context.Context, []*Team) error) map[string]func(context.Context, []*Team) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Team) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

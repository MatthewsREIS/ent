...
func (_q *ZooQuery) All(ctx context.Context) ([]*Zoo, error) {
	return entbuilder.RunAll[[]*Zoo](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Zoo, error) { return _q.sqlAll(ctx) })
}
...
func (_q *ZooQuery) IncludeForeignKeys(bool) *ZooQuery {
	return _q
}

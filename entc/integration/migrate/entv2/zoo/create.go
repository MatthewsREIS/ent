...
// NewZooCreate returns a new ZooCreate initialized with the given config, hooks, and mutation.
func NewZooCreate(c Config, hooks []Hook, mutation *ZooMutation) *ZooCreate {
...
// NewZooCreateBulk returns a new ZooCreateBulk initialized with the given config and builders.
func NewZooCreateBulk(c Config, builders []*ZooCreate) *ZooCreateBulk {
	return &ZooCreateBulk{Config: c, builders: builders}
}

// NewZooCreateBulkErr returns a new ZooCreateBulk that returns the given error on Save.
func NewZooCreateBulkErr(err error) *ZooCreateBulk {
	return &ZooCreateBulk{err: err}
}

...
func (_q *MediaQuery) All(ctx context.Context) ([]*Media, error) {
	nodes, err := entbuilder.RunAll[[]*Media](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Media, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

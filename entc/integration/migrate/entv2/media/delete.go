...
func (_d *MediaDelete) Where(ps ...predicate.Media) *MediaDelete { _d.mutation.Where(ps...); return _d }
...
func (_d *MediaDelete) ExecX(ctx context.Context) int { return entbuilder.Must(_d.Exec(ctx)) }

...
func (_q *BlogQuery) First(ctx context.Context) (*Blog, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Blog, []*Blog](ctx, _q, _q.Ctx, ent.OpQueryFirst, blog.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Blog, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *BlogQuery) Only(ctx context.Context) (*Blog, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Blog, []*Blog](ctx, _q, _q.Ctx, ent.OpQueryOnly, blog.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Blog, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}

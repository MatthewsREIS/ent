...
func (_q *ZooQuery) Limit(limit int) *ZooQuery { _q.ctx.Limit = &limit; return _q }

// Offset to start from.
func (_q *ZooQuery) Offset(offset int) *ZooQuery { _q.ctx.Offset = &offset; return _q }

// Unique configures the query builder to filter duplicate records on query.
// By default, unique is set to true, and can be disabled using this method.
func (_q *ZooQuery) Unique(unique bool) *ZooQuery { _q.ctx.Unique = &unique; return _q }
...
func (_q *ZooQuery) OnlyX(ctx context.Context) *Zoo { return entbuilder.Must(_q.Only(ctx)) }
...
func (_q *ZooQuery) OnlyIDX(ctx context.Context) int { return entbuilder.Must(_q.OnlyID(ctx)) }
...
func (_q *ZooQuery) AllX(ctx context.Context) []*Zoo { return entbuilder.Must(_q.All(ctx)) }
...
func (_q *ZooQuery) IDsX(ctx context.Context) []int { return entbuilder.Must(_q.IDs(ctx)) }
...
func (_q *ZooQuery) CountX(ctx context.Context) int { return entbuilder.Must(_q.Count(ctx)) }
...
func (_q *ZooQuery) ExistX(ctx context.Context) bool { return entbuilder.Must(_q.Exist(ctx)) }

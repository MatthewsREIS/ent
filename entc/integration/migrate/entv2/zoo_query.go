...
func (_q *ZooQuery) First(ctx context.Context) (*Zoo, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Zoo, []*Zoo](ctx, _q, _q.Ctx, ent.OpQueryFirst, zoo.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Zoo, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *ZooQuery) Only(ctx context.Context) (*Zoo, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Zoo, []*Zoo](ctx, _q, _q.Ctx, ent.OpQueryOnly, zoo.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Zoo, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}

...
func (m *CustomTypeMutation) Fields() []string {
	...
	if m.tz0 != nil {
		fields = append(fields, "tz0")
	}
	if m.tz3 != nil {
		fields = append(fields, "tz3")
	}
	return fields
}
...
func (m *CustomTypeMutation) ClearedFields() []string {
	...
	if m.FieldCleared("tz0") {
		fields = append(fields, "tz0")
	}
	if m.FieldCleared("tz3") {
		fields = append(fields, "tz3")
	}
	return fields
}

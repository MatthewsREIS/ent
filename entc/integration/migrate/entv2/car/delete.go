...
func (_d *CarDelete) Where(ps ...predicate.Car) *CarDelete { _d.mutation.Where(ps...); return _d }
...
func (_d *CarDelete) ExecX(ctx context.Context) int { return entbuilder.Must(_d.Exec(ctx)) }

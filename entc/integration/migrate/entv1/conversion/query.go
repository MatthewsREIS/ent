...
type ConversionQuery struct {
	...
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Conversion) error
}
...
func (_q *ConversionQuery) StoreEager(name string, loader func(context.Context, []*Conversion) error) *ConversionQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Conversion) error)
	}
...
func (_q *ConversionQuery) EagerLoaders() map[string]func(context.Context, []*Conversion) error {
...
func (_q *ConversionQuery) Order(o ...OrderOption) *ConversionQuery {
...
func (_q *ConversionQuery) First(ctx context.Context) (*Conversion, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Conversion, []*Conversion](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Conversion, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *ConversionQuery) Only(ctx context.Context) (*Conversion, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Conversion, []*Conversion](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Conversion, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *ConversionQuery) Clone() *ConversionQuery {
	...
	return &ConversionQuery{
		...
		eagerLoaders: cloneEagerLoadersConversion(_q.eagerLoaders),
	}
}
...
// dispatch loop.
func (_q *ConversionQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Conversion, error) {
	var (
		nodes = []*Conversion{}
		_spec = _q.querySpec()
	)
...
func (_q *ConversionQuery) IncludeForeignKeys(bool) *ConversionQuery {
	return _q
}
...
// cloneEagerLoadersConversion returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersConversion(in map[string]func(context.Context, []*Conversion) error) map[string]func(context.Context, []*Conversion) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Conversion) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

...
func (_q *ConversionQuery) All(ctx context.Context) ([]*Conversion, error) {
	nodes, err := entbuilder.RunAll[[]*Conversion](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Conversion, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

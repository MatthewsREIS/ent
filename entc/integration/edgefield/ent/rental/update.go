...
// NewRentalUpdate returns a new RentalUpdate initialized with the given config, hooks, and mutation.
func NewRentalUpdate(c Config, hooks []Hook, mutation *RentalMutation) *RentalUpdate {
	return &RentalUpdate{Config: c, hooks: hooks, mutation: mutation}
}
...
// NewRentalUpdateOne returns a new RentalUpdateOne initialized with the given config, hooks, and mutation.
func NewRentalUpdateOne(c Config, hooks []Hook, mutation *RentalMutation) *RentalUpdateOne {

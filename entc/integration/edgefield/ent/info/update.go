...
// NewInfoUpdate returns a new InfoUpdate initialized with the given config, hooks, and mutation.
func NewInfoUpdate(c Config, hooks []Hook, mutation *InfoMutation) *InfoUpdate {
	return &InfoUpdate{Config: c, hooks: hooks, mutation: mutation}
}
...
func (_u *InfoUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AppendedContent(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, FieldContent, value)
		})
	}
...
// NewInfoUpdateOne returns a new InfoUpdateOne initialized with the given config, hooks, and mutation.
func NewInfoUpdateOne(c Config, hooks []Hook, mutation *InfoMutation) *InfoUpdateOne {

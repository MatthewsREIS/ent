...
func (*Metadata) ScanValues(columns []string) ([]any, error) {
	return entbuilder.ScanTargets(metadataDescriptor, columns)
}

// AssignValues assigns the values that were returned from sql.Rows (after scanning)
// to the Metadata fields.
func (_m *Metadata) AssignValues(columns []string, values []any) error {
	return entbuilder.AssignRow(metadataDescriptor, _m, columns, values, func(c string, v any) {
...
func (_m *Metadata) String() string {
	return entbuilder.FormatEntity(metadataDescriptor, _m)
}

...
type MetadataQuery struct {
	...
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Metadata) error
}
...
func (_q *MetadataQuery) StoreEager(name string, loader func(context.Context, []*Metadata) error) *MetadataQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Metadata) error)
	}
...
func (_q *MetadataQuery) EagerLoaders() map[string]func(context.Context, []*Metadata) error {
...
func (_q *MetadataQuery) Order(o ...OrderOption) *MetadataQuery {
...
func (_q *MetadataQuery) First(ctx context.Context) (*Metadata, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Metadata, []*Metadata](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Metadata, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *MetadataQuery) Only(ctx context.Context) (*Metadata, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Metadata, []*Metadata](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Metadata, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *MetadataQuery) All(ctx context.Context) ([]*Metadata, error) {
	nodes, err := entbuilder.RunAll[[]*Metadata](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Metadata, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (_q *MetadataQuery) Clone() *MetadataQuery {
	...
	return &MetadataQuery{
		...
		eagerLoaders: cloneEagerLoadersMetadata(_q.eagerLoaders),
	}
}
...
func (_q *MetadataQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Metadata, error) {
...
// cloneEagerLoadersMetadata returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersMetadata(in map[string]func(context.Context, []*Metadata) error) map[string]func(context.Context, []*Metadata) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Metadata) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

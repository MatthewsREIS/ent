...
func (_q *LinkQuery) All(ctx context.Context) ([]*Link, error) {
	nodes, err := entbuilder.RunAll[[]*Link](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Link, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

...
func (_d *NoteDelete) Where(ps ...predicate.Note) *NoteDelete { _d.mutation.Where(ps...); return _d }
...
func (_d *NoteDelete) ExecX(ctx context.Context) int { return entbuilder.Must(_d.Exec(ctx)) }

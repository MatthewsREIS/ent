...
type CarQuery struct {
	...
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Car) error
	withFKs      bool
}
...
func (_q *CarQuery) StoreEager(name string, loader func(context.Context, []*Car) error) *CarQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Car) error)
	}
...
func (_q *CarQuery) EagerLoaders() map[string]func(context.Context, []*Car) error {
...
func (_q *CarQuery) Order(o ...OrderOption) *CarQuery {
...
func (_q *CarQuery) First(ctx context.Context) (*Car, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Car, []*Car](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Car, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *CarQuery) Only(ctx context.Context) (*Car, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Car, []*Car](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Car, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *CarQuery) Clone() *CarQuery {
	...
	return &CarQuery{
		...
		eagerLoaders: cloneEagerLoadersCar(_q.eagerLoaders),
	}
}
...
// dispatch loop.
func (_q *CarQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Car, error) {
	var (
		nodes       = []*Car{}
		withFKs     = _q.withFKs
		_spec       = _q.querySpec()
...
func (_q *CarQuery) IncludeForeignKeys(b bool) *CarQuery {
	_q.withFKs = b
	return _q
}
...
// cloneEagerLoadersCar returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersCar(in map[string]func(context.Context, []*Car) error) map[string]func(context.Context, []*Car) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Car) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

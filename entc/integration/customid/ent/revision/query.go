...
type RevisionQuery struct {
	...
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Revision) error
}
...
func (_q *RevisionQuery) StoreEager(name string, loader func(context.Context, []*Revision) error) *RevisionQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Revision) error)
	}
...
func (_q *RevisionQuery) EagerLoaders() map[string]func(context.Context, []*Revision) error {
...
func (_q *RevisionQuery) Order(o ...OrderOption) *RevisionQuery {
...
func (_q *RevisionQuery) First(ctx context.Context) (*Revision, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Revision, []*Revision](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Revision, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *RevisionQuery) Only(ctx context.Context) (*Revision, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Revision, []*Revision](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Revision, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *RevisionQuery) All(ctx context.Context) ([]*Revision, error) {
	nodes, err := entbuilder.RunAll[[]*Revision](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Revision, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (_q *RevisionQuery) Clone() *RevisionQuery {
	...
	return &RevisionQuery{
		...
		eagerLoaders: cloneEagerLoadersRevision(_q.eagerLoaders),
	}
}
...
func (_q *RevisionQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Revision, error) {
...
// cloneEagerLoadersRevision returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersRevision(in map[string]func(context.Context, []*Revision) error) map[string]func(context.Context, []*Revision) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Revision) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

...
const (
	...
	// TypeAccount holds the string denoting the account type in the database.
	TypeAccount = "Account"
)
...
type AccountEdges = internal.AccountEdges
type Accounts = internal.Accounts

// Mutation type aliases and constructors from internal.
type AccountMutation = internal.AccountMutation
type AccountMutationOption = internal.AccountMutationOption

var NewAccountMutation = internal.NewAccountMutation
var WithAccountID = internal.WithAccountID
var WithAccount = internal.WithAccount
var WithAccountIDsFunc = internal.WithAccountIDsFunc

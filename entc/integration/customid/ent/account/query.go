...
func (_q *AccountQuery) All(ctx context.Context) ([]*Account, error) {
	return entbuilder.RunAll[[]*Account](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Account, error) { return _q.sqlAll(ctx) })
}
...
func (_q *AccountQuery) IncludeForeignKeys(bool) *AccountQuery {
	return _q
}

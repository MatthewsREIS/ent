...
func (_q *LinkQuery) Limit(limit int) *LinkQuery { _q.ctx.Limit = &limit; return _q }

// Offset to start from.
func (_q *LinkQuery) Offset(offset int) *LinkQuery { _q.ctx.Offset = &offset; return _q }

// Unique configures the query builder to filter duplicate records on query.
// By default, unique is set to true, and can be disabled using this method.
func (_q *LinkQuery) Unique(unique bool) *LinkQuery { _q.ctx.Unique = &unique; return _q }
...
func (_q *LinkQuery) OnlyX(ctx context.Context) *Link { return entbuilder.Must(_q.Only(ctx)) }
...
func (_q *LinkQuery) OnlyIDX(ctx context.Context) uuidc.UUIDC { return entbuilder.Must(_q.OnlyID(ctx)) }
...
func (_q *LinkQuery) AllX(ctx context.Context) []*Link { return entbuilder.Must(_q.All(ctx)) }
...
func (_q *LinkQuery) IDsX(ctx context.Context) []uuidc.UUIDC { return entbuilder.Must(_q.IDs(ctx)) }
...
func (_q *LinkQuery) CountX(ctx context.Context) int { return entbuilder.Must(_q.Count(ctx)) }
...
func (_q *LinkQuery) ExistX(ctx context.Context) bool { return entbuilder.Must(_q.Exist(ctx)) }

...
func (_q *LinkQuery) First(ctx context.Context) (*Link, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Link, []*Link](ctx, _q, _q.Ctx, ent.OpQueryFirst, link.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Link, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *LinkQuery) Only(ctx context.Context) (*Link, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Link, []*Link](ctx, _q, _q.Ctx, ent.OpQueryOnly, link.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Link, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}

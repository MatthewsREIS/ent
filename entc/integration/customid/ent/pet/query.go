...
type PetQuery struct {
	...
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Pet) error
	withFKs      bool
}
...
func (_q *PetQuery) StoreEager(name string, loader func(context.Context, []*Pet) error) *PetQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Pet) error)
	}
...
func (_q *PetQuery) EagerLoaders() map[string]func(context.Context, []*Pet) error {
...
func (_q *PetQuery) Order(o ...OrderOption) *PetQuery {
...
func (_q *PetQuery) First(ctx context.Context) (*Pet, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Pet, []*Pet](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Pet, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *PetQuery) Only(ctx context.Context) (*Pet, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Pet, []*Pet](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Pet, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *PetQuery) Clone() *PetQuery {
	...
	return &PetQuery{
		...
		eagerLoaders: cloneEagerLoadersPet(_q.eagerLoaders),
	}
}
...
// dispatch loop.
func (_q *PetQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Pet, error) {
	var (
		nodes       = []*Pet{}
		withFKs     = _q.withFKs
		_spec       = _q.querySpec()
		loadedTypes = [4]bool{
			...
			_q.eagerLoaders["cars"] != nil,
			_q.eagerLoaders["friends"] != nil,
			_q.eagerLoaders["best_friend"] != nil,
		}
	)
	if _q.eagerLoaders["owner"] != nil || _q.eagerLoaders["best_friend"] != nil {
		withFKs = true
	}
	if withFKs {
...
func (_q *PetQuery) IncludeForeignKeys(b bool) *PetQuery {
	_q.withFKs = b
	return _q
}
...
// cloneEagerLoadersPet returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersPet(in map[string]func(context.Context, []*Pet) error) map[string]func(context.Context, []*Pet) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Pet) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

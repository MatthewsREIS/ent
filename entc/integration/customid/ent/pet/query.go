...
func (_q *PetQuery) All(ctx context.Context) ([]*Pet, error) {
	nodes, err := entbuilder.RunAll[[]*Pet](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Pet, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

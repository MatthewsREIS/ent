...
var schemaGraph = func() *sqlgraph.Schema {
	...
	graph.Nodes[0] = &sqlgraph.Node{
		...
		Fields: map[string]*sqlgraph.FieldSpec{
			FieldUUID:  {Type: field.TypeUUID, Column: FieldUUID},
			FieldCount: {Type: field.TypeInt, Column: FieldCount},
		},
	}
	graph.Nodes[1] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			...
			CompositeID: []*sqlgraph.FieldSpec{
				{Type: field.TypeUUID, Column: "blob_id"},
				{Type: field.TypeUUID, Column: "link_id"},
			},
		},
		Type: "BlobLink",
		Fields: map[string]*sqlgraph.FieldSpec{
			"created_at": {Type: field.TypeTime, Column: "created_at"},
			"blob_id":    {Type: field.TypeUUID, Column: "blob_id"},
			"link_id":    {Type: field.TypeUUID, Column: "link_id"},
		},
	}
	graph.MustAddE(
		"parent",
	...
	graph.MustAddE(
		...
		&sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   BlobLinksTable,
			Columns: []string{BlobLinksColumn},
			Bidi:    false,
		},
		"Blob",
		"BlobLink",

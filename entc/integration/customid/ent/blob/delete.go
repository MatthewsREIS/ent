...
func (_d *BlobDelete) Where(ps ...predicate.Blob) *BlobDelete { _d.mutation.Where(ps...); return _d }
...
func (_d *BlobDelete) ExecX(ctx context.Context) int { return entbuilder.Must(_d.Exec(ctx)) }

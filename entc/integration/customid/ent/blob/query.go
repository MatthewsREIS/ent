...
func (_q *BlobQuery) All(ctx context.Context) ([]*Blob, error) {
	nodes, err := entbuilder.RunAll[[]*Blob](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Blob, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

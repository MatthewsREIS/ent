...
type RevisionMutation struct {
	...
	idsFunc       func(context.Context, ...predicate.Revision) ([]string, error)
}
...
func (m *RevisionMutation) SetMutationID(id *string) { m.id = id }

// SetDone marks the mutation as completed.
func (m *RevisionMutation) SetDone() { m.done = true }

// MutationPredicates returns the list of predicates for update/delete mutations.
func (m *RevisionMutation) MutationPredicates() []predicate.Revision { return m.predicates }

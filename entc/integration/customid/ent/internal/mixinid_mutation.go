...
type MixinIDMutation struct {
	...
	idsFunc       func(context.Context, ...predicate.MixinID) ([]uuid.UUID, error)
}
...
func (m *MixinIDMutation) Fields() []string {
	...
	if m.some_field != nil {
		fields = append(fields, "some_field")
	}
	if m.mixin_field != nil {
		fields = append(fields, "mixin_field")
	}
	return fields
}
...
func (m *MixinIDMutation) SetMutationID(id *uuid.UUID) { m.id = id }

// SetDone marks the mutation as completed.
func (m *MixinIDMutation) SetDone() { m.done = true }

// MutationPredicates returns the list of predicates for update/delete mutations.
func (m *MixinIDMutation) MutationPredicates() []predicate.MixinID { return m.predicates }

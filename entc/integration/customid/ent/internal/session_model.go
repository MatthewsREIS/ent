...
func (e SessionEdges) DeviceOrErr() (*Device, error) {
	if e.Device != nil {
		...
		return nil, &NotFoundError{Label: "Device"}
	}
...
// SetDeviceSessions sets the device_sessions foreign key.
func (_m *Session) SetDeviceSessions(v schema.ID) {
	_m.device_sessions = &v
}

// GetDeviceSessions returns the device_sessions foreign key value.
func (_m *Session) GetDeviceSessions() *schema.ID {
	return _m.device_sessions
}

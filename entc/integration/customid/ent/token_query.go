...
func (_q *TokenQuery) Limit(limit int) *TokenQuery { _q.ctx.Limit = &limit; return _q }

// Offset to start from.
func (_q *TokenQuery) Offset(offset int) *TokenQuery { _q.ctx.Offset = &offset; return _q }

// Unique configures the query builder to filter duplicate records on query.
// By default, unique is set to true, and can be disabled using this method.
func (_q *TokenQuery) Unique(unique bool) *TokenQuery { _q.ctx.Unique = &unique; return _q }
...
func (_q *TokenQuery) OnlyX(ctx context.Context) *Token { return entbuilder.Must(_q.Only(ctx)) }
...
func (_q *TokenQuery) OnlyIDX(ctx context.Context) sid.ID { return entbuilder.Must(_q.OnlyID(ctx)) }
...
func (_q *TokenQuery) AllX(ctx context.Context) []*Token { return entbuilder.Must(_q.All(ctx)) }
...
func (_q *TokenQuery) IDsX(ctx context.Context) []sid.ID { return entbuilder.Must(_q.IDs(ctx)) }
...
func (_q *TokenQuery) CountX(ctx context.Context) int { return entbuilder.Must(_q.Count(ctx)) }
...
func (_q *TokenQuery) ExistX(ctx context.Context) bool { return entbuilder.Must(_q.Exist(ctx)) }

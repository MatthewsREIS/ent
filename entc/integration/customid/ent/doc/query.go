...
type DocQuery struct {
	...
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Doc) error
	withFKs      bool
}
...
func (_q *DocQuery) StoreEager(name string, loader func(context.Context, []*Doc) error) *DocQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Doc) error)
	}
...
func (_q *DocQuery) EagerLoaders() map[string]func(context.Context, []*Doc) error {
...
func (_q *DocQuery) Order(o ...OrderOption) *DocQuery {
...
func (_q *DocQuery) First(ctx context.Context) (*Doc, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Doc, []*Doc](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Doc, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *DocQuery) Only(ctx context.Context) (*Doc, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Doc, []*Doc](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Doc, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *DocQuery) Clone() *DocQuery {
	...
	return &DocQuery{
		...
		eagerLoaders: cloneEagerLoadersDoc(_q.eagerLoaders),
	}
}
...
// dispatch loop.
func (_q *DocQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Doc, error) {
	var (
		nodes       = []*Doc{}
		withFKs     = _q.withFKs
		_spec       = _q.querySpec()
...
func (_q *DocQuery) IncludeForeignKeys(b bool) *DocQuery {
	_q.withFKs = b
	return _q
}
...
// cloneEagerLoadersDoc returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersDoc(in map[string]func(context.Context, []*Doc) error) map[string]func(context.Context, []*Doc) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Doc) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

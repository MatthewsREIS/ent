...
func (_q *DocQuery) All(ctx context.Context) ([]*Doc, error) {
	nodes, err := entbuilder.RunAll[[]*Doc](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Doc, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

...
func (_q *MixinIDQuery) All(ctx context.Context) ([]*MixinID, error) {
	return entbuilder.RunAll[[]*MixinID](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*MixinID, error) { return _q.sqlAll(ctx) })
}
...
func (_q *MixinIDQuery) IncludeForeignKeys(bool) *MixinIDQuery {
	return _q
}

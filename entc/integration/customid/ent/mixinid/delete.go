...
func NewMixinIDDelete(c Config, hooks []Hook, mutation *MixinIDMutation) *MixinIDDelete {
	return &MixinIDDelete{Config: c, hooks: hooks, mutation: mutation}
}
...
func (_d *MixinIDDelete) ExecX(ctx context.Context) int { return entbuilder.Must(_d.Exec(ctx)) }

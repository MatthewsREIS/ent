...
func (_d *TokenDelete) Where(ps ...predicate.Token) *TokenDelete { _d.mutation.Where(ps...); return _d }
...
func (_d *TokenDelete) ExecX(ctx context.Context) int { return entbuilder.Must(_d.Exec(ctx)) }

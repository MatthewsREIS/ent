...
func (_q *TokenQuery) All(ctx context.Context) ([]*Token, error) {
	nodes, err := entbuilder.RunAll[[]*Token](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Token, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

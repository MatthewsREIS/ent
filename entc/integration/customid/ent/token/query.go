...
type TokenQuery struct {
	Config
	entbuilder.QueryState[predicate.Token]
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Token) error
	withFKs      bool
}
...
func (_q *TokenQuery) StoreEager(name string, loader func(context.Context, []*Token) error) *TokenQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Token) error)
	}
...
func (_q *TokenQuery) EagerLoaders() map[string]func(context.Context, []*Token) error {
...
func (_q *TokenQuery) Order(o ...OrderOption) *TokenQuery {
...
func (_q *TokenQuery) First(ctx context.Context) (*Token, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Token, []*Token](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Token, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *TokenQuery) Only(ctx context.Context) (*Token, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Token, []*Token](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Token, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *TokenQuery) All(ctx context.Context) ([]*Token, error) {
	return entbuilder.RunAll[[]*Token](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Token, error) { return _q.sqlAll(ctx) })
}
...
func (_q *TokenQuery) Clone() *TokenQuery {
	...
	return &TokenQuery{
		...
		eagerLoaders: cloneEagerLoadersToken(_q.eagerLoaders),
	}
}
...
// dispatch loop.
func (_q *TokenQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Token, error) {
	var (
		nodes       = []*Token{}
		withFKs     = _q.withFKs
		_spec       = _q.querySpec()
		loadedTypes = [1]bool{
			_q.eagerLoaders["account"] != nil,
		}
	)
	if _q.eagerLoaders["account"] != nil {
		withFKs = true
	}
	if withFKs {
...
func (_q *TokenQuery) IncludeForeignKeys(b bool) *TokenQuery {
	_q.withFKs = b
	return _q
}
...
func (_g *TokenGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*TokenQuery, *TokenGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *TokenSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*TokenQuery, *TokenSelect](ctx, _s.TokenQuery, _s, _s.QueryState.Inters, v)
}
...
// cloneEagerLoadersToken returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersToken(in map[string]func(context.Context, []*Token) error) map[string]func(context.Context, []*Token) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Token) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

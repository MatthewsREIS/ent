...
func (_q *OtherQuery) All(ctx context.Context) ([]*Other, error) {
	nodes, err := entbuilder.RunAll[[]*Other](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Other, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

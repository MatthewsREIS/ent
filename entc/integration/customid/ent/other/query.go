...
type OtherQuery struct {
	Config
	entbuilder.QueryState[predicate.Other]
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Other) error
}
...
func (_q *OtherQuery) StoreEager(name string, loader func(context.Context, []*Other) error) *OtherQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Other) error)
	}
...
func (_q *OtherQuery) EagerLoaders() map[string]func(context.Context, []*Other) error {
...
func (_q *OtherQuery) Order(o ...OrderOption) *OtherQuery {
...
func (_q *OtherQuery) First(ctx context.Context) (*Other, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Other, []*Other](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Other, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *OtherQuery) Only(ctx context.Context) (*Other, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Other, []*Other](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Other, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *OtherQuery) All(ctx context.Context) ([]*Other, error) {
	return entbuilder.RunAll[[]*Other](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Other, error) { return _q.sqlAll(ctx) })
}
...
func (_q *OtherQuery) Clone() *OtherQuery {
	...
	return &OtherQuery{
		...
		eagerLoaders: cloneEagerLoadersOther(_q.eagerLoaders),
	}
}
...
// dispatch loop.
func (_q *OtherQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Other, error) {
	var (
		nodes = []*Other{}
		_spec = _q.querySpec()
	)
...
func (_q *OtherQuery) IncludeForeignKeys(bool) *OtherQuery {
	return _q
}
...
func (_g *OtherGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*OtherQuery, *OtherGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *OtherSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*OtherQuery, *OtherSelect](ctx, _s.OtherQuery, _s, _s.QueryState.Inters, v)
}
...
// cloneEagerLoadersOther returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersOther(in map[string]func(context.Context, []*Other) error) map[string]func(context.Context, []*Other) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Other) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

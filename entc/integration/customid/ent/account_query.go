...
func (_q *AccountQuery) First(ctx context.Context) (*Account, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Account, []*Account](ctx, _q, _q.Ctx, ent.OpQueryFirst, account.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Account, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *AccountQuery) Only(ctx context.Context) (*Account, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Account, []*Account](ctx, _q, _q.Ctx, ent.OpQueryOnly, account.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Account, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}

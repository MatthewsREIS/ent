...
func (_q *MixinIDQuery) First(ctx context.Context) (*MixinID, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*MixinID, []*MixinID](ctx, _q, _q.Ctx, ent.OpQueryFirst, mixinid.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*MixinID, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *MixinIDQuery) Only(ctx context.Context) (*MixinID, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*MixinID, []*MixinID](ctx, _q, _q.Ctx, ent.OpQueryOnly, mixinid.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*MixinID, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}

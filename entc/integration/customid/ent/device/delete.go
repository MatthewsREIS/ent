...
func NewDeviceDelete(c Config, hooks []Hook, mutation *DeviceMutation) *DeviceDelete {
	return &DeviceDelete{Config: c, hooks: hooks, mutation: mutation}
}
...
func (_d *DeviceDelete) Exec(ctx context.Context) (int, error) {
	return entbuilder.RunDelete(ctx, &entbuilder.DeleteState[*DeviceMutation]{Hooks: _d.hooks, Mutation: _d.mutation}, _d.sqlExec)
}

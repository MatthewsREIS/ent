...
func (_q *DeviceQuery) All(ctx context.Context) ([]*Device, error) {
	nodes, err := entbuilder.RunAll[[]*Device](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Device, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

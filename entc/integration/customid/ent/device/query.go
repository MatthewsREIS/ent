...
type DeviceQuery struct {
	...
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Device) error
	withFKs      bool
}
...
func (_q *DeviceQuery) StoreEager(name string, loader func(context.Context, []*Device) error) *DeviceQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Device) error)
	}
...
func (_q *DeviceQuery) EagerLoaders() map[string]func(context.Context, []*Device) error {
...
func (_q *DeviceQuery) Order(o ...OrderOption) *DeviceQuery {
...
func (_q *DeviceQuery) First(ctx context.Context) (*Device, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Device, []*Device](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Device, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *DeviceQuery) Only(ctx context.Context) (*Device, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Device, []*Device](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Device, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *DeviceQuery) Clone() *DeviceQuery {
	...
	return &DeviceQuery{
		...
		eagerLoaders: cloneEagerLoadersDevice(_q.eagerLoaders),
	}
}
...
// dispatch loop.
func (_q *DeviceQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Device, error) {
	var (
		nodes       = []*Device{}
		withFKs     = _q.withFKs
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
			_q.eagerLoaders["active_session"] != nil,
			_q.eagerLoaders["sessions"] != nil,
		}
	)
	if _q.eagerLoaders["active_session"] != nil {
		withFKs = true
	}
	if withFKs {
...
func (_q *DeviceQuery) IncludeForeignKeys(b bool) *DeviceQuery {
	_q.withFKs = b
	return _q
}
...
// cloneEagerLoadersDevice returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersDevice(in map[string]func(context.Context, []*Device) error) map[string]func(context.Context, []*Device) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Device) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

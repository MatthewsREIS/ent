...
func NewBlobLinkDelete(c Config, hooks []Hook, mutation *BlobLinkMutation) *BlobLinkDelete {
	return &BlobLinkDelete{Config: c, hooks: hooks, mutation: mutation}
}
...
func (_d *BlobLinkDelete) ExecX(ctx context.Context) int { return entbuilder.Must(_d.Exec(ctx)) }

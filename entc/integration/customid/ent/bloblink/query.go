...
func (_q *BlobLinkQuery) All(ctx context.Context) ([]*BlobLink, error) {
	nodes, err := entbuilder.RunAll[[]*BlobLink](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*BlobLink, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

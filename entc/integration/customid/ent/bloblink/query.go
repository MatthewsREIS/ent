...
type BlobLinkQuery struct {
	Config
	entbuilder.QueryState[predicate.BlobLink]
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*BlobLink) error
}
...
func (_q *BlobLinkQuery) StoreEager(name string, loader func(context.Context, []*BlobLink) error) *BlobLinkQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*BlobLink) error)
	}
...
func (_q *BlobLinkQuery) EagerLoaders() map[string]func(context.Context, []*BlobLink) error {
...
func (_q *BlobLinkQuery) Order(o ...OrderOption) *BlobLinkQuery {
...
func (_q *BlobLinkQuery) First(ctx context.Context) (*BlobLink, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*BlobLink, []*BlobLink](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*BlobLink, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *BlobLinkQuery) Only(ctx context.Context) (*BlobLink, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*BlobLink, []*BlobLink](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*BlobLink, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *BlobLinkQuery) All(ctx context.Context) ([]*BlobLink, error) {
	return entbuilder.RunAll[[]*BlobLink](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*BlobLink, error) { return _q.sqlAll(ctx) })
}
...
func (_q *BlobLinkQuery) Clone() *BlobLinkQuery {
	...
	return &BlobLinkQuery{
		...
		eagerLoaders: cloneEagerLoadersBlobLink(_q.eagerLoaders),
	}
}
...
// dispatch loop.
func (_q *BlobLinkQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*BlobLink, error) {
	var (
		nodes       = []*BlobLink{}
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
			_q.eagerLoaders["blob"] != nil,
			_q.eagerLoaders["link"] != nil,
		}
	)
...
func (_q *BlobLinkQuery) IncludeForeignKeys(bool) *BlobLinkQuery {
	return _q
}
...
func (_q *BlobLinkQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.Ctx.Fields; len(fields) > 0 {
		...
		if _, ok := _q.eagerLoaders["blob"]; ok {
			_spec.Node.AddColumnOnce(FieldBlobID)
		}
		if _, ok := _q.eagerLoaders["link"]; ok {
			_spec.Node.AddColumnOnce(FieldLinkID)
		}
	}
...
func (_g *BlobLinkGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*BlobLinkQuery, *BlobLinkGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *BlobLinkSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*BlobLinkQuery, *BlobLinkSelect](ctx, _s.BlobLinkQuery, _s, _s.QueryState.Inters, v)
}
...
// cloneEagerLoadersBlobLink returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersBlobLink(in map[string]func(context.Context, []*BlobLink) error) map[string]func(context.Context, []*BlobLink) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*BlobLink) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

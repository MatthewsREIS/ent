...
func (_q *OtherQuery) First(ctx context.Context) (*Other, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Other, []*Other](ctx, _q, _q.Ctx, ent.OpQueryFirst, other.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Other, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *OtherQuery) Only(ctx context.Context) (*Other, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Other, []*Other](ctx, _q, _q.Ctx, ent.OpQueryOnly, other.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Other, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}

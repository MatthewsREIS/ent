...
func (_q *TweetQuery) Limit(limit int) *TweetQuery { _q.ctx.Limit = &limit; return _q }

// Offset to start from.
func (_q *TweetQuery) Offset(offset int) *TweetQuery { _q.ctx.Offset = &offset; return _q }

// Unique configures the query builder to filter duplicate records on query.
// By default, unique is set to true, and can be disabled using this method.
func (_q *TweetQuery) Unique(unique bool) *TweetQuery { _q.ctx.Unique = &unique; return _q }
...
func (_q *TweetQuery) OnlyX(ctx context.Context) *Tweet { return entbuilder.Must(_q.Only(ctx)) }
...
func (_q *TweetQuery) OnlyIDX(ctx context.Context) int { return entbuilder.Must(_q.OnlyID(ctx)) }
...
func (_q *TweetQuery) AllX(ctx context.Context) []*Tweet { return entbuilder.Must(_q.All(ctx)) }
...
func (_q *TweetQuery) IDsX(ctx context.Context) []int { return entbuilder.Must(_q.IDs(ctx)) }
...
func (_q *TweetQuery) CountX(ctx context.Context) int { return entbuilder.Must(_q.Count(ctx)) }
...
func (_q *TweetQuery) ExistX(ctx context.Context) bool { return entbuilder.Must(_q.Exist(ctx)) }

...
type RoleQuery struct {
	Config
	entbuilder.QueryState[predicate.Role]
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Role) error
}
...
func (_q *RoleQuery) StoreEager(name string, loader func(context.Context, []*Role) error) *RoleQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Role) error)
	}
...
func (_q *RoleQuery) EagerLoaders() map[string]func(context.Context, []*Role) error {
...
func (_q *RoleQuery) Order(o ...OrderOption) *RoleQuery {
...
func (_q *RoleQuery) First(ctx context.Context) (*Role, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Role, []*Role](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Role, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *RoleQuery) Only(ctx context.Context) (*Role, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Role, []*Role](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Role, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *RoleQuery) All(ctx context.Context) ([]*Role, error) {
	return entbuilder.RunAll[[]*Role](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Role, error) { return _q.sqlAll(ctx) })
}
...
func (_q *RoleQuery) Clone() *RoleQuery {
	...
	return &RoleQuery{
		...
		eagerLoaders: cloneEagerLoadersRole(_q.eagerLoaders),
	}
}
...
// dispatch loop.
func (_q *RoleQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Role, error) {
	var (
		nodes       = []*Role{}
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
...
func (_q *RoleQuery) IncludeForeignKeys(bool) *RoleQuery {
	return _q
}
...
func (_g *RoleGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*RoleQuery, *RoleGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *RoleSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*RoleQuery, *RoleSelect](ctx, _s.RoleQuery, _s, _s.QueryState.Inters, v)
}
...
// cloneEagerLoadersRole returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersRole(in map[string]func(context.Context, []*Role) error) map[string]func(context.Context, []*Role) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Role) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

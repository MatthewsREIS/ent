...
func (_q *UserQuery) All(ctx context.Context) ([]*User, error) {
	nodes, err := entbuilder.RunAll[[]*User](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*User, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	var (
		...
		loadedTypes = [12]bool{
			...
			_q.eagerLoaders["relatives"] != nil,
			_q.eagerLoaders["liked_tweets"] != nil,
			_q.eagerLoaders["tweets"] != nil,
			_q.eagerLoaders["roles"] != nil,
			_q.eagerLoaders["joined_groups"] != nil,
			_q.eagerLoaders["friendships"] != nil,
			_q.eagerLoaders["relationship"] != nil,
			_q.eagerLoaders["likes"] != nil,
			_q.eagerLoaders["user_tweets"] != nil,
			_q.eagerLoaders["roles_users"] != nil,
		}
	)

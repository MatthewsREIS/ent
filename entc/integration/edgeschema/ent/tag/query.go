...
func (_q *TagQuery) All(ctx context.Context) ([]*Tag, error) {
	nodes, err := entbuilder.RunAll[[]*Tag](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Tag, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

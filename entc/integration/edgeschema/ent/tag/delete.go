...
func (_d *TagDelete) Where(ps ...predicate.Tag) *TagDelete { _d.mutation.Where(ps...); return _d }
...
func (_d *TagDelete) ExecX(ctx context.Context) int { return entbuilder.Must(_d.Exec(ctx)) }

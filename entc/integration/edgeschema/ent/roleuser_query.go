...
func (_q *RoleUserQuery) Limit(limit int) *RoleUserQuery { _q.ctx.Limit = &limit; return _q }

// Offset to start from.
func (_q *RoleUserQuery) Offset(offset int) *RoleUserQuery { _q.ctx.Offset = &offset; return _q }

// Unique configures the query builder to filter duplicate records on query.
// By default, unique is set to true, and can be disabled using this method.
func (_q *RoleUserQuery) Unique(unique bool) *RoleUserQuery { _q.ctx.Unique = &unique; return _q }
...
func (_q *RoleUserQuery) OnlyX(ctx context.Context) *RoleUser { return entbuilder.Must(_q.Only(ctx)) }
...
func (_q *RoleUserQuery) AllX(ctx context.Context) []*RoleUser { return entbuilder.Must(_q.All(ctx)) }
...
func (_q *RoleUserQuery) CountX(ctx context.Context) int { return entbuilder.Must(_q.Count(ctx)) }
...
func (_q *RoleUserQuery) ExistX(ctx context.Context) bool { return entbuilder.Must(_q.Exist(ctx)) }

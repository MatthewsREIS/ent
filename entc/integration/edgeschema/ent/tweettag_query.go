...
func (_q *TweetTagQuery) First(ctx context.Context) (*TweetTag, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*TweetTag, []*TweetTag](ctx, _q, _q.Ctx, ent.OpQueryFirst, tweettag.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*TweetTag, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *TweetTagQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	...
	if len(ids) == 0 {
		err = &NotFoundError{Label: tweettag.Label}
		return
	}
	return ids[0], nil
}
...
func (_q *TweetTagQuery) Only(ctx context.Context) (*TweetTag, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*TweetTag, []*TweetTag](ctx, _q, _q.Ctx, ent.OpQueryOnly, tweettag.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*TweetTag, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *TweetTagQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	...
	case 0:
		err = &NotFoundError{Label: tweettag.Label}
	default:
		err = &NotSingularError{Label: tweettag.Label}
	}
	return
}

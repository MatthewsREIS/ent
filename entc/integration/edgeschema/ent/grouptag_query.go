...
func (_q *GroupTagQuery) First(ctx context.Context) (*GroupTag, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*GroupTag, []*GroupTag](ctx, _q, _q.Ctx, ent.OpQueryFirst, grouptag.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*GroupTag, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *GroupTagQuery) Only(ctx context.Context) (*GroupTag, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*GroupTag, []*GroupTag](ctx, _q, _q.Ctx, ent.OpQueryOnly, grouptag.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*GroupTag, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}

...
const (
	...
	// TypeTweet holds the string denoting the tweet type in the database.
	TypeTweet = "Tweet"
)
...
type Tweet = internal.Tweet
type TweetEdges = internal.TweetEdges
type Tweets = internal.Tweets

...
func (_q *RoleQuery) First(ctx context.Context) (*Role, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Role, []*Role](ctx, _q, _q.Ctx, ent.OpQueryFirst, role.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Role, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *RoleQuery) Only(ctx context.Context) (*Role, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Role, []*Role](ctx, _q, _q.Ctx, ent.OpQueryOnly, role.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Role, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}

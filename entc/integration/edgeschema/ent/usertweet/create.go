...
// to the UserTweetCreate builder. The first error from as is recorded and returned by Save.
func (_c *UserTweetCreate) With(as ...entfield.Assignment) *UserTweetCreate {
	if _c.err == nil {

...
func (c *TweetLikeClient) Create() *TweetLikeCreate {
	...
	return NewTweetLikeCreate(c.Config, c.Hooks(), mutation)
}
...
func (c *TweetLikeClient) CreateBulk(builders ...*TweetLikeCreate) *TweetLikeCreateBulk {
	return NewTweetLikeCreateBulk(c.Config, builders)
}
...
func (c *TweetLikeClient) MapCreateBulk(slice any, setFunc func(*TweetLikeCreate, int)) *TweetLikeCreateBulk {
	...
	if rv.Kind() != reflect.Slice {
		return NewTweetLikeCreateBulkErr(fmt.Errorf("calling to TweetLikeClient.MapCreateBulk with wrong type %T, need slice", slice))
	}
...
func (c *TweetLikeClient) Update() *TweetLikeUpdate {
	...
	return NewTweetLikeUpdate(c.Config, c.Hooks(), mutation)
}
...
func (c *TweetLikeClient) UpdateOne(_m *TweetLike) *TweetLikeUpdateOne {
	...
	return NewTweetLikeUpdateOne(c.Config, c.Hooks(), mutation)
}
...
func (c *TweetLikeClient) Delete() *TweetLikeDelete {
	...
	return NewTweetLikeDelete(c.Config, c.Hooks(), mutation)
}
...
func (c *TweetLikeClient) Mutate(ctx context.Context, m *TweetLikeMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return NewTweetLikeCreate(c.Config, c.Hooks(), m).Save(ctx)
	case OpUpdate:
		return NewTweetLikeUpdate(c.Config, c.Hooks(), m).Save(ctx)
	case OpUpdateOne:
		return NewTweetLikeUpdateOne(c.Config, c.Hooks(), m).Save(ctx)
	case OpDelete, OpDeleteOne:
		return NewTweetLikeDelete(c.Config, c.Hooks(), m).Exec(ctx)
	default:

...
func (_q *TweetLikeQuery) All(ctx context.Context) ([]*TweetLike, error) {
	nodes, err := entbuilder.RunAll[[]*TweetLike](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*TweetLike, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

...
func (_q *UserGroupQuery) Limit(limit int) *UserGroupQuery { _q.ctx.Limit = &limit; return _q }

// Offset to start from.
func (_q *UserGroupQuery) Offset(offset int) *UserGroupQuery { _q.ctx.Offset = &offset; return _q }

// Unique configures the query builder to filter duplicate records on query.
// By default, unique is set to true, and can be disabled using this method.
func (_q *UserGroupQuery) Unique(unique bool) *UserGroupQuery { _q.ctx.Unique = &unique; return _q }
...
func (_q *UserGroupQuery) Only(ctx context.Context) (*UserGroup, error) {
	...
	case 0:
		return nil, &NotFoundError{Label: usergroup.Label}
	default:
		return nil, &NotSingularError{Label: usergroup.Label}
	}
}

// OnlyX is like Only, but panics if an error occurs.
func (_q *UserGroupQuery) OnlyX(ctx context.Context) *UserGroup { return entbuilder.Must(_q.Only(ctx)) }
...
func (_q *UserGroupQuery) OnlyIDX(ctx context.Context) int { return entbuilder.Must(_q.OnlyID(ctx)) }
...
func (_q *UserGroupQuery) AllX(ctx context.Context) []*UserGroup { return entbuilder.Must(_q.All(ctx)) }
...
func (_q *UserGroupQuery) IDsX(ctx context.Context) []int { return entbuilder.Must(_q.IDs(ctx)) }
...
func (_q *UserGroupQuery) CountX(ctx context.Context) int { return entbuilder.Must(_q.Count(ctx)) }
...
func (_q *UserGroupQuery) ExistX(ctx context.Context) bool { return entbuilder.Must(_q.Exist(ctx)) }

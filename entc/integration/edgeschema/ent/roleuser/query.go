...
func (_q *RoleUserQuery) All(ctx context.Context) ([]*RoleUser, error) {
	nodes, err := entbuilder.RunAll[[]*RoleUser](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*RoleUser, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

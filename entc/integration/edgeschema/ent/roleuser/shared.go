...
const (
	...
	// TypeRoleUser holds the string denoting the roleuser type in the database.
...
type RoleUser = internal.RoleUser
type RoleUserEdges = internal.RoleUserEdges
type RoleUsers = internal.RoleUsers
	...
	graph.Nodes[0] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			...
			CompositeID: []*sqlgraph.FieldSpec{
				...
				{Type: field.TypeInt, Column: FieldRoleID},
			},
		},
		Type: "RoleUser",
		Fields: map[string]*sqlgraph.FieldSpec{
			FieldCreatedAt: {Type: field.TypeTime, Column: FieldCreatedAt},
			FieldRoleID:    {Type: field.TypeInt, Column: FieldRoleID},
			FieldUserID:    {Type: field.TypeInt, Column: FieldUserID},
		},
	}
	graph.Nodes[1] = &sqlgraph.Node{Type: "Role"}

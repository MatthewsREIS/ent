...
// Field holds typed predicate/order handles for every comparable field of the RoleUser type.
var Field = struct {
...
// Edge holds typed edge handles for every edge of the RoleUser type.
var Edge = struct {

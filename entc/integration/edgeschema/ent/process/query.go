...
type ProcessQuery struct {
	...
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Process) error
}
...
func (_q *ProcessQuery) StoreEager(name string, loader func(context.Context, []*Process) error) *ProcessQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Process) error)
	}
...
func (_q *ProcessQuery) EagerLoaders() map[string]func(context.Context, []*Process) error {
...
func (_q *ProcessQuery) Order(o ...OrderOption) *ProcessQuery {
...
func (_q *ProcessQuery) First(ctx context.Context) (*Process, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Process, []*Process](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Process, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *ProcessQuery) Only(ctx context.Context) (*Process, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Process, []*Process](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Process, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *ProcessQuery) All(ctx context.Context) ([]*Process, error) {
	nodes, err := entbuilder.RunAll[[]*Process](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Process, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (_q *ProcessQuery) Clone() *ProcessQuery {
	...
	return &ProcessQuery{
		...
		eagerLoaders: cloneEagerLoadersProcess(_q.eagerLoaders),
	}
}
...
func (_q *ProcessQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Process, error) {
	var (
		...
		loadedTypes = [2]bool{
			...
			_q.eagerLoaders["attached_files"] != nil,
		}
	)
...
func (_q *ProcessQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Process, error) {
...
// cloneEagerLoadersProcess returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersProcess(in map[string]func(context.Context, []*Process) error) map[string]func(context.Context, []*Process) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Process) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

...
func (_q *TagQuery) First(ctx context.Context) (*Tag, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Tag, []*Tag](ctx, _q, _q.Ctx, ent.OpQueryFirst, tag.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Tag, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *TagQuery) Only(ctx context.Context) (*Tag, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Tag, []*Tag](ctx, _q, _q.Ctx, ent.OpQueryOnly, tag.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Tag, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}

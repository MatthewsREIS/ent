...
func (_q *TagQuery) Limit(limit int) *TagQuery { _q.ctx.Limit = &limit; return _q }

// Offset to start from.
func (_q *TagQuery) Offset(offset int) *TagQuery { _q.ctx.Offset = &offset; return _q }

// Unique configures the query builder to filter duplicate records on query.
// By default, unique is set to true, and can be disabled using this method.
func (_q *TagQuery) Unique(unique bool) *TagQuery { _q.ctx.Unique = &unique; return _q }
...
func (_q *TagQuery) OnlyX(ctx context.Context) *Tag { return entbuilder.Must(_q.Only(ctx)) }
...
func (_q *TagQuery) OnlyIDX(ctx context.Context) int { return entbuilder.Must(_q.OnlyID(ctx)) }
...
func (_q *TagQuery) AllX(ctx context.Context) []*Tag { return entbuilder.Must(_q.All(ctx)) }
...
func (_q *TagQuery) IDsX(ctx context.Context) []int { return entbuilder.Must(_q.IDs(ctx)) }
...
func (_q *TagQuery) CountX(ctx context.Context) int { return entbuilder.Must(_q.Count(ctx)) }
...
func (_q *TagQuery) ExistX(ctx context.Context) bool { return entbuilder.Must(_q.Exist(ctx)) }

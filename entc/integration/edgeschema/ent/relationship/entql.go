...
func NewRelationshipFilterForMutation(m *RelationshipMutation) *RelationshipFilter {
	return &RelationshipFilter{Config: m.Config.(Config), predicateAdder: m}
}

...
// NewRelationshipCreate returns a new RelationshipCreate initialized with the given config, hooks, and mutation.
func NewRelationshipCreate(c Config, hooks []Hook, mutation *RelationshipMutation) *RelationshipCreate {
...
func ThroughDefaults(c Config) *sqlgraph.CreateSpec {
	m := NewRelationshipMutation(c, OpCreate)
	b := &RelationshipCreate{Config: c, mutation: m}
	b.defaults()
	_, spec := b.createSpec()
	return spec
}
...
// NewRelationshipCreateBulk returns a new RelationshipCreateBulk initialized with the given config and builders.
func NewRelationshipCreateBulk(c Config, builders []*RelationshipCreate) *RelationshipCreateBulk {
	return &RelationshipCreateBulk{Config: c, builders: builders}
}

// NewRelationshipCreateBulkErr returns a new RelationshipCreateBulk that returns the given error on Save.
func NewRelationshipCreateBulkErr(err error) *RelationshipCreateBulk {
	return &RelationshipCreateBulk{err: err}
}

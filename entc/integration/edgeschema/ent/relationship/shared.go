...
const (
	...
	// TypeRelationship holds the string denoting the relationship type in the database.
...
type RelationshipEdges = internal.RelationshipEdges
type Relationships = internal.Relationships
	...
	graph.Nodes[0] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			...
			CompositeID: []*sqlgraph.FieldSpec{
				{Type: field.TypeInt, Column: FieldUserID},
				{Type: field.TypeInt, Column: FieldRelativeID},
			},
		},
		Type: "Relationship",
		Fields: map[string]*sqlgraph.FieldSpec{
			FieldWeight:     {Type: field.TypeInt, Column: FieldWeight},
			FieldUserID:     {Type: field.TypeInt, Column: FieldUserID},
			FieldRelativeID: {Type: field.TypeInt, Column: FieldRelativeID},
			FieldInfoID:     {Type: field.TypeInt, Column: FieldInfoID},
		},
	}
	graph.Nodes[1] = &sqlgraph.Node{Type: "User"}
	graph.Nodes[2] = &sqlgraph.Node{Type: "RelationshipInfo"}
	graph.MustAddE(
		"user",
		&sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,

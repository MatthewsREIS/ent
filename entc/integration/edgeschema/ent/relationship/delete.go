...
func NewRelationshipDelete(c Config, hooks []Hook, mutation *RelationshipMutation) *RelationshipDelete {
	return &RelationshipDelete{Config: c, hooks: hooks, mutation: mutation}
}
...
func (_d *RelationshipDelete) ExecX(ctx context.Context) int { return entbuilder.Must(_d.Exec(ctx)) }
...
func NewRelationshipDeleteOne(d *RelationshipDelete) *RelationshipDeleteOne {
	return &RelationshipDeleteOne{_d: d}
}

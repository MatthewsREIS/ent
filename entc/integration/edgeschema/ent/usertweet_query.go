...
func (_q *UserTweetQuery) First(ctx context.Context) (*UserTweet, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*UserTweet, []*UserTweet](ctx, _q, _q.Ctx, ent.OpQueryFirst, usertweet.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*UserTweet, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *UserTweetQuery) Only(ctx context.Context) (*UserTweet, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*UserTweet, []*UserTweet](ctx, _q, _q.Ctx, ent.OpQueryOnly, usertweet.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*UserTweet, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}

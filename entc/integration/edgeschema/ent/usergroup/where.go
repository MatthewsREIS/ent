...
// Field holds typed predicate/order handles for every comparable field of the UserGroup type.
var Field = struct {
...
// Edge holds typed edge handles for every edge of the UserGroup type.
var Edge = struct {

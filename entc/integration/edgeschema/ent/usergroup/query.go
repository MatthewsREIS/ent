...
type UserGroupQuery struct {
	...
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*UserGroup) error
}
...
func (_q *UserGroupQuery) StoreEager(name string, loader func(context.Context, []*UserGroup) error) *UserGroupQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*UserGroup) error)
	}
...
func (_q *UserGroupQuery) EagerLoaders() map[string]func(context.Context, []*UserGroup) error {
...
func (_q *UserGroupQuery) Order(o ...OrderOption) *UserGroupQuery {
...
func (_q *UserGroupQuery) First(ctx context.Context) (*UserGroup, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*UserGroup, []*UserGroup](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*UserGroup, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *UserGroupQuery) Only(ctx context.Context) (*UserGroup, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*UserGroup, []*UserGroup](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*UserGroup, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *UserGroupQuery) Clone() *UserGroupQuery {
	...
	return &UserGroupQuery{
		...
		eagerLoaders: cloneEagerLoadersUserGroup(_q.eagerLoaders),
	}
}
...
// dispatch loop.
func (_q *UserGroupQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*UserGroup, error) {
	var (
		nodes       = []*UserGroup{}
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
			_q.eagerLoaders["user"] != nil,
			_q.eagerLoaders["group"] != nil,
		}
	)
...
func (_q *UserGroupQuery) IncludeForeignKeys(bool) *UserGroupQuery {
	return _q
}
...
func (_q *UserGroupQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.Ctx.Fields; len(fields) > 0 {
		...
		if _, ok := _q.eagerLoaders["group"]; ok {
			_spec.Node.AddColumnOnce(FieldGroupID)
		}
	}
...
// cloneEagerLoadersUserGroup returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersUserGroup(in map[string]func(context.Context, []*UserGroup) error) map[string]func(context.Context, []*UserGroup) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*UserGroup) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

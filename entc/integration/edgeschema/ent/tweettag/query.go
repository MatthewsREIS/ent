...
func (_q *TweetTagQuery) All(ctx context.Context) ([]*TweetTag, error) {
	nodes, err := entbuilder.RunAll[[]*TweetTag](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*TweetTag, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

...
func (_q *RelationshipInfoQuery) All(ctx context.Context) ([]*RelationshipInfo, error) {
	nodes, err := entbuilder.RunAll[[]*RelationshipInfo](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*RelationshipInfo, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

...
func (c *BuilderClient) Create() *BuilderCreate {
	...
	return NewBuilderCreate(c.Config, c.Hooks(), mutation)
}
...
func (c *BuilderClient) CreateBulk(builders ...*BuilderCreate) *BuilderCreateBulk {
	return NewBuilderCreateBulk(c.Config, builders)
}
...
func (c *BuilderClient) MapCreateBulk(slice any, setFunc func(*BuilderCreate, int)) *BuilderCreateBulk {
	...
	if rv.Kind() != reflect.Slice {
		return NewBuilderCreateBulkErr(fmt.Errorf("calling to BuilderClient.MapCreateBulk with wrong type %T, need slice", slice))
	}
...
func (c *BuilderClient) Update() *BuilderUpdate {
	...
	return NewBuilderUpdate(c.Config, c.Hooks(), mutation)
}
...
func (c *BuilderClient) UpdateOne(_m *Builder) *BuilderUpdateOne {
	...
	return NewBuilderUpdateOne(c.Config, c.Hooks(), mutation)
}
...
func (c *BuilderClient) Delete() *BuilderDelete {
	...
	return NewBuilderDelete(c.Config, c.Hooks(), mutation)
}
...
func (c *BuilderClient) Mutate(ctx context.Context, m *BuilderMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return NewBuilderCreate(c.Config, c.Hooks(), m).Save(ctx)
	case OpUpdate:
		return NewBuilderUpdate(c.Config, c.Hooks(), m).Save(ctx)
	case OpUpdateOne:
		return NewBuilderUpdateOne(c.Config, c.Hooks(), m).Save(ctx)
	case OpDelete, OpDeleteOne:
		return NewBuilderDelete(c.Config, c.Hooks(), m).Exec(ctx)
	default:

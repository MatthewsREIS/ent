...
func (_g *UserGroupBy) gremlinScan(ctx context.Context, root *UserQuery, v any) error {
	var (
		trs   []any
		names []any
	)
...
func (_s *UserSelect) gremlinScan(ctx context.Context, root *UserQuery, v any) error {
	var (
		res       = &gremlin.Response{}

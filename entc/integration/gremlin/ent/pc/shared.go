...
const (
	...
	// TypePC holds the string denoting the pc type in the database.
	TypePC = "PC"
)
...
type PC = internal.PC
type PCs = internal.PCs

// Mutation type aliases and constructors from internal.
type PCMutation = internal.PCMutation
type PCMutationOption = internal.PCMutationOption

var NewPCMutation = internal.NewPCMutation
var WithPCID = internal.WithPCID
var WithPC = internal.WithPC
var WithPCIDsFunc = internal.WithPCIDsFunc

...
func (c *FieldTypeClient) Create() *FieldTypeCreate {
	...
	return NewFieldTypeCreate(c.Config, c.Hooks(), mutation)
}
...
func (c *FieldTypeClient) CreateBulk(builders ...*FieldTypeCreate) *FieldTypeCreateBulk {
	return NewFieldTypeCreateBulk(c.Config, builders)
}
...
func (c *FieldTypeClient) MapCreateBulk(slice any, setFunc func(*FieldTypeCreate, int)) *FieldTypeCreateBulk {
	...
	if rv.Kind() != reflect.Slice {
		return NewFieldTypeCreateBulkErr(fmt.Errorf("calling to FieldTypeClient.MapCreateBulk with wrong type %T, need slice", slice))
	}
...
func (c *FieldTypeClient) Update() *FieldTypeUpdate {
	...
	return NewFieldTypeUpdate(c.Config, c.Hooks(), mutation)
}
...
func (c *FieldTypeClient) UpdateOne(_m *FieldType) *FieldTypeUpdateOne {
	...
	return NewFieldTypeUpdateOne(c.Config, c.Hooks(), mutation)
}
...
func (c *FieldTypeClient) Delete() *FieldTypeDelete {
	...
	return NewFieldTypeDelete(c.Config, c.Hooks(), mutation)
}
...
func (c *FieldTypeClient) Mutate(ctx context.Context, m *FieldTypeMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return NewFieldTypeCreate(c.Config, c.Hooks(), m).Save(ctx)
	case OpUpdate:
		return NewFieldTypeUpdate(c.Config, c.Hooks(), m).Save(ctx)
	case OpUpdateOne:
		return NewFieldTypeUpdateOne(c.Config, c.Hooks(), m).Save(ctx)
	case OpDelete, OpDeleteOne:
		return NewFieldTypeDelete(c.Config, c.Hooks(), m).Exec(ctx)
	default:

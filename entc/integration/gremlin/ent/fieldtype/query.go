...
func (_g *FieldTypeGroupBy) gremlinScan(ctx context.Context, root *FieldTypeQuery, v any) error {
	var (
		trs   []any
		names []any
	)
...
func (_s *FieldTypeSelect) gremlinScan(ctx context.Context, root *FieldTypeQuery, v any) error {
	var (
		res       = &gremlin.Response{}

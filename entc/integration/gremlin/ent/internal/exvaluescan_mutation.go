...
type ExValueScanMutation struct {
	...
	idsFunc         func(context.Context, ...predicate.ExValueScan) ([]string, error)
}
...
func WithExValueScanID(id string, getFunc func(context.Context, string) (*ExValueScan, error)) ExValueScanMutationOption {
...
func WithExValueScanIDsFunc(fn func(context.Context, ...predicate.ExValueScan) ([]string, error)) ExValueScanMutationOption {
	return func(m *ExValueScanMutation) {
		m.idsFunc = fn
	}
}
...
func (m *ExValueScanMutation) WhereP(ps ...func(*dsl.Traversal)) {
...
func (m *ExValueScanMutation) SetMutationID(id *string) { m.id = id }
...
func (m *ExValueScanMutation) AddPredicate(pred func(s *dsl.Traversal)) {

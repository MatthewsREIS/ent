...
type FileMutation struct {
	...
	idsFunc       func(context.Context, ...predicate.File) ([]string, error)
}
...
func (m *FileMutation) SetMutationID(id *string) { m.id = id }
...
func (m *FileMutation) AddPredicate(pred func(s *dsl.Traversal)) {

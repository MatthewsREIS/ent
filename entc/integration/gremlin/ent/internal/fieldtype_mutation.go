...
type FieldTypeMutation struct {
	...
	idsFunc                    func(context.Context, ...predicate.FieldType) ([]string, error)
}
...
func (m *FieldTypeMutation) SetMutationID(id *string) { m.id = id }
...
func (m *FieldTypeMutation) AddPredicate(pred func(s *dsl.Traversal)) {

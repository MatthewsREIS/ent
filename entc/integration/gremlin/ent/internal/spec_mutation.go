...
type SpecMutation struct {
	...
	idsFunc       func(context.Context, ...predicate.Spec) ([]string, error)
}
...
func (m *SpecMutation) SetMutationID(id *string) { m.id = id }
...
func (m *SpecMutation) AddPredicate(pred func(s *dsl.Traversal)) {

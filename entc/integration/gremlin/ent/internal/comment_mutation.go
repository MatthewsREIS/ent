...
type CommentMutation struct {
	...
	idsFunc         func(context.Context, ...predicate.Comment) ([]string, error)
}
...
func (m *CommentMutation) SetMutationID(id *string) { m.id = id }
...
func (m *CommentMutation) AddPredicate(pred func(s *dsl.Traversal)) {

...
type FileTypeMutation struct {
	...
	idsFunc       func(context.Context, ...predicate.FileType) ([]string, error)
}
...
func WithFileTypeID(id string, getFunc func(context.Context, string) (*FileType, error)) FileTypeMutationOption {
...
func WithFileTypeIDsFunc(fn func(context.Context, ...predicate.FileType) ([]string, error)) FileTypeMutationOption {
	return func(m *FileTypeMutation) {
		m.idsFunc = fn
	}
}
...
func (m *FileTypeMutation) SetMutationID(id *string) { m.id = id }
...
func (m *FileTypeMutation) AddPredicate(pred func(s *dsl.Traversal)) {

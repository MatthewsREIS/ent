...
func (_q *CardQuery) Limit(limit int) *CardQuery { _q.ctx.Limit = &limit; return _q }

// Offset to start from.
func (_q *CardQuery) Offset(offset int) *CardQuery { _q.ctx.Offset = &offset; return _q }

// Unique configures the query builder to filter duplicate records on query.
// By default, unique is set to true, and can be disabled using this method.
func (_q *CardQuery) Unique(unique bool) *CardQuery { _q.ctx.Unique = &unique; return _q }
...
func (_q *CardQuery) OnlyX(ctx context.Context) *Card { return entbuilder.Must(_q.Only(ctx)) }
...
func (_q *CardQuery) OnlyIDX(ctx context.Context) string { return entbuilder.Must(_q.OnlyID(ctx)) }
...
func (_q *CardQuery) AllX(ctx context.Context) []*Card { return entbuilder.Must(_q.All(ctx)) }
...
func (_q *CardQuery) IDsX(ctx context.Context) []string { return entbuilder.Must(_q.IDs(ctx)) }
...
func (_q *CardQuery) CountX(ctx context.Context) int { return entbuilder.Must(_q.Count(ctx)) }
...
func (_q *CardQuery) ExistX(ctx context.Context) bool { return entbuilder.Must(_q.Exist(ctx)) }

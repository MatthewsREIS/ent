...
func (_q *ItemQuery) gremlinAll(ctx context.Context, hooks ...queryHook) ([]*Item, error) {
...
func (_q *ItemQuery) gremlinQuery(context.Context) *dsl.Traversal {
...
func (_g *ItemGroupBy) gremlinScan(ctx context.Context, root *ItemQuery, v any) error {
	var (
		trs   []any
		names []any
	)
...
func (_s *ItemSelect) gremlinScan(ctx context.Context, root *ItemQuery, v any) error {
	var (
		res       = &gremlin.Response{}

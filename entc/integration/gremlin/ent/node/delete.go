...
func (_d *NodeDelete) Where(ps ...predicate.Node) *NodeDelete { _d.mutation.Where(ps...); return _d }
...
func (_d *NodeDelete) ExecX(ctx context.Context) int { return entbuilder.Must(_d.Exec(ctx)) }

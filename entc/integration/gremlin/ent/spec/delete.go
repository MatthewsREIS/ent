...
func (_d *SpecDelete) Where(ps ...predicate.Spec) *SpecDelete { _d.mutation.Where(ps...); return _d }
...
func (_d *SpecDelete) ExecX(ctx context.Context) int { return entbuilder.Must(_d.Exec(ctx)) }

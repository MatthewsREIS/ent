...
func (_q *LicenseQuery) Limit(limit int) *LicenseQuery { _q.ctx.Limit = &limit; return _q }

// Offset to start from.
func (_q *LicenseQuery) Offset(offset int) *LicenseQuery { _q.ctx.Offset = &offset; return _q }

// Unique configures the query builder to filter duplicate records on query.
// By default, unique is set to true, and can be disabled using this method.
func (_q *LicenseQuery) Unique(unique bool) *LicenseQuery { _q.ctx.Unique = &unique; return _q }
...
func (_q *LicenseQuery) OnlyX(ctx context.Context) *License { return entbuilder.Must(_q.Only(ctx)) }
...
func (_q *LicenseQuery) OnlyIDX(ctx context.Context) int { return entbuilder.Must(_q.OnlyID(ctx)) }
...
func (_q *LicenseQuery) AllX(ctx context.Context) []*License { return entbuilder.Must(_q.All(ctx)) }
...
func (_q *LicenseQuery) IDsX(ctx context.Context) []int { return entbuilder.Must(_q.IDs(ctx)) }
...
func (_q *LicenseQuery) CountX(ctx context.Context) int { return entbuilder.Must(_q.Count(ctx)) }
...
func (_q *LicenseQuery) ExistX(ctx context.Context) bool { return entbuilder.Must(_q.Exist(ctx)) }

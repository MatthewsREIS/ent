...
func (_q *UserQuery) OnlyIDX(ctx context.Context) string { return entbuilder.Must(_q.OnlyID(ctx)) }
...
func (_q *UserQuery) IDsX(ctx context.Context) []string { return entbuilder.Must(_q.IDs(ctx)) }

...
func (c *GoodsClient) Create() *GoodsCreate {
	...
	return NewGoodsCreate(c.Config, c.Hooks(), mutation)
}
...
func (c *GoodsClient) CreateBulk(builders ...*GoodsCreate) *GoodsCreateBulk {
	return NewGoodsCreateBulk(c.Config, builders)
}
...
func (c *GoodsClient) MapCreateBulk(slice any, setFunc func(*GoodsCreate, int)) *GoodsCreateBulk {
	...
	if rv.Kind() != reflect.Slice {
		return NewGoodsCreateBulkErr(fmt.Errorf("calling to GoodsClient.MapCreateBulk with wrong type %T, need slice", slice))
	}
...
func (c *GoodsClient) Update() *GoodsUpdate {
	...
	return NewGoodsUpdate(c.Config, c.Hooks(), mutation)
}
...
func (c *GoodsClient) UpdateOne(_m *Goods) *GoodsUpdateOne {
	...
	return NewGoodsUpdateOne(c.Config, c.Hooks(), mutation)
}
...
func (c *GoodsClient) Delete() *GoodsDelete {
	...
	return NewGoodsDelete(c.Config, c.Hooks(), mutation)
}
...
func (c *GoodsClient) Mutate(ctx context.Context, m *GoodsMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return NewGoodsCreate(c.Config, c.Hooks(), m).Save(ctx)
	case OpUpdate:
		return NewGoodsUpdate(c.Config, c.Hooks(), m).Save(ctx)
	case OpUpdateOne:
		return NewGoodsUpdateOne(c.Config, c.Hooks(), m).Save(ctx)
	case OpDelete, OpDeleteOne:
		return NewGoodsDelete(c.Config, c.Hooks(), m).Exec(ctx)
	default:

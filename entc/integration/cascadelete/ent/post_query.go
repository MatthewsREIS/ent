...
func (_q *PostQuery) First(ctx context.Context) (*Post, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Post, []*Post](ctx, _q, _q.Ctx, ent.OpQueryFirst, post.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Post, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *PostQuery) FirstID(ctx context.Context) (id int, err error) {
	...
	if len(ids) == 0 {
		err = &NotFoundError{Label: post.Label}
		return
	}
	return ids[0], nil
}
...
func (_q *PostQuery) Only(ctx context.Context) (*Post, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Post, []*Post](ctx, _q, _q.Ctx, ent.OpQueryOnly, post.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Post, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *PostQuery) OnlyID(ctx context.Context) (id int, err error) {
	...
	case 0:
		err = &NotFoundError{Label: post.Label}
	default:
		err = &NotSingularError{Label: post.Label}
	}
	return
}

...
func (_q *CommentQuery) All(ctx context.Context) ([]*Comment, error) {
	nodes, err := entbuilder.RunAll[[]*Comment](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Comment, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

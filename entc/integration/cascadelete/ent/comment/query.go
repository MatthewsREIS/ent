...
type CommentQuery struct {
	Config
	entbuilder.QueryState[predicate.Comment]
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Comment) error
}
...
func (_q *CommentQuery) StoreEager(name string, loader func(context.Context, []*Comment) error) *CommentQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Comment) error)
	}
...
func (_q *CommentQuery) EagerLoaders() map[string]func(context.Context, []*Comment) error {
...
func (_q *CommentQuery) Order(o ...OrderOption) *CommentQuery {
...
func (_q *CommentQuery) First(ctx context.Context) (*Comment, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Comment, []*Comment](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Comment, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *CommentQuery) Only(ctx context.Context) (*Comment, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Comment, []*Comment](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Comment, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *CommentQuery) All(ctx context.Context) ([]*Comment, error) {
	return entbuilder.RunAll[[]*Comment](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Comment, error) { return _q.sqlAll(ctx) })
}
...
func (_q *CommentQuery) Clone() *CommentQuery {
	...
	return &CommentQuery{
		...
		eagerLoaders: cloneEagerLoadersComment(_q.eagerLoaders),
	}
}
...
// dispatch loop.
func (_q *CommentQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Comment, error) {
	var (
		nodes       = []*Comment{}
		_spec       = _q.querySpec()
		loadedTypes = [1]bool{
			_q.eagerLoaders["post"] != nil,
		}
	)
...
func (_q *CommentQuery) IncludeForeignKeys(bool) *CommentQuery {
	return _q
}
...
func (_q *CommentQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.Ctx.Fields; len(fields) > 0 {
		...
		if _, ok := _q.eagerLoaders["post"]; ok {
			_spec.Node.AddColumnOnce(FieldPostID)
		}
	}
...
func (_g *CommentGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*CommentQuery, *CommentGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *CommentSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*CommentQuery, *CommentSelect](ctx, _s.CommentQuery, _s, _s.QueryState.Inters, v)
}
...
// cloneEagerLoadersComment returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersComment(in map[string]func(context.Context, []*Comment) error) map[string]func(context.Context, []*Comment) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Comment) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

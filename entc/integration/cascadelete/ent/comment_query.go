...
func (_q *CommentQuery) First(ctx context.Context) (*Comment, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Comment, []*Comment](ctx, _q, _q.Ctx, ent.OpQueryFirst, comment.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Comment, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *CommentQuery) Only(ctx context.Context) (*Comment, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Comment, []*Comment](ctx, _q, _q.Ctx, ent.OpQueryOnly, comment.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Comment, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}

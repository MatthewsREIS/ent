...
func (_d *PostDelete) Where(ps ...predicate.Post) *PostDelete { _d.mutation.Where(ps...); return _d }
...
func (_d *PostDelete) ExecX(ctx context.Context) int { return entbuilder.Must(_d.Exec(ctx)) }

...
func (_q *PostQuery) All(ctx context.Context) ([]*Post, error) {
	nodes, err := entbuilder.RunAll[[]*Post](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Post, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

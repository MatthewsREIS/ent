...
type PostQuery struct {
	Config
	entbuilder.QueryState[predicate.Post]
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Post) error
}
...
func (_q *PostQuery) StoreEager(name string, loader func(context.Context, []*Post) error) *PostQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Post) error)
	}
...
func (_q *PostQuery) EagerLoaders() map[string]func(context.Context, []*Post) error {
...
func (_q *PostQuery) Order(o ...OrderOption) *PostQuery {
...
func (_q *PostQuery) First(ctx context.Context) (*Post, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Post, []*Post](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Post, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *PostQuery) Only(ctx context.Context) (*Post, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Post, []*Post](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Post, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *PostQuery) All(ctx context.Context) ([]*Post, error) {
	return entbuilder.RunAll[[]*Post](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Post, error) { return _q.sqlAll(ctx) })
}
...
func (_q *PostQuery) Clone() *PostQuery {
	...
	return &PostQuery{
		...
		eagerLoaders: cloneEagerLoadersPost(_q.eagerLoaders),
	}
}
...
// dispatch loop.
func (_q *PostQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Post, error) {
	var (
		nodes       = []*Post{}
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
			_q.eagerLoaders["author"] != nil,
			_q.eagerLoaders["comments"] != nil,
		}
	)
...
func (_q *PostQuery) IncludeForeignKeys(bool) *PostQuery {
	return _q
}
...
func (_q *PostQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.Ctx.Fields; len(fields) > 0 {
		...
		if _, ok := _q.eagerLoaders["author"]; ok {
			_spec.Node.AddColumnOnce(FieldAuthorID)
		}
	}
...
func (_g *PostGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*PostQuery, *PostGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *PostSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*PostQuery, *PostSelect](ctx, _s.PostQuery, _s, _s.QueryState.Inters, v)
}
...
// cloneEagerLoadersPost returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersPost(in map[string]func(context.Context, []*Post) error) map[string]func(context.Context, []*Post) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Post) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

...
type BuilderMutation struct {
	...
	idsFunc       func(context.Context, ...predicate.Builder) ([]int, error)
}
...
func WithBuilderID(id int, getFunc func(context.Context, int) (*Builder, error)) BuilderMutationOption {
...
func WithBuilderIDsFunc(fn func(context.Context, ...predicate.Builder) ([]int, error)) BuilderMutationOption {
	return func(m *BuilderMutation) {
		m.idsFunc = fn
	}
}
...
func (m *BuilderMutation) SetMutationID(id *int) { m.id = id }

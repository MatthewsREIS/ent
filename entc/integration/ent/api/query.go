...
type APIQuery struct {
	...
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Api) error
...
func (_q *APIQuery) StoreEager(name string, loader func(context.Context, []*Api) error) *APIQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Api) error)
	}
...
func (_q *APIQuery) EagerLoaders() map[string]func(context.Context, []*Api) error {
...
func (_q *APIQuery) Order(o ...OrderOption) *APIQuery {
...
func (_q *APIQuery) First(ctx context.Context) (*Api, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Api, []*Api](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Api, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *APIQuery) Only(ctx context.Context) (*Api, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Api, []*Api](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Api, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *APIQuery) Clone() *APIQuery {
	...
	return &APIQuery{
		...
		eagerLoaders: cloneEagerLoadersApi(_q.eagerLoaders),
...
// dispatch loop.
func (_q *APIQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Api, error) {
	var (
		nodes = []*Api{}
		_spec = _q.querySpec()
	)
...
func (_q *APIQuery) IncludeForeignKeys(bool) *APIQuery {
	return _q
}
...
// cloneEagerLoadersApi returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersApi(in map[string]func(context.Context, []*Api) error) map[string]func(context.Context, []*Api) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Api) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

...
type ItemQuery struct {
	Config
	entbuilder.QueryState[predicate.Item]
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Item) error
...
func (_q *ItemQuery) StoreEager(name string, loader func(context.Context, []*Item) error) *ItemQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Item) error)
	}
...
func (_q *ItemQuery) EagerLoaders() map[string]func(context.Context, []*Item) error {
...
func (_q *ItemQuery) Order(o ...OrderOption) *ItemQuery {
...
func (_q *ItemQuery) First(ctx context.Context) (*Item, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Item, []*Item](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Item, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *ItemQuery) Only(ctx context.Context) (*Item, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Item, []*Item](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Item, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *ItemQuery) All(ctx context.Context) ([]*Item, error) {
	return entbuilder.RunAll[[]*Item](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Item, error) { return _q.sqlAll(ctx) })
}
...
func (_q *ItemQuery) Clone() *ItemQuery {
	...
	return &ItemQuery{
		...
		eagerLoaders: cloneEagerLoadersItem(_q.eagerLoaders),
...
// dispatch loop.
func (_q *ItemQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Item, error) {
	var (
		nodes = []*Item{}
		_spec = _q.querySpec()
	)
...
func (_q *ItemQuery) IncludeForeignKeys(bool) *ItemQuery {
	return _q
}
...
func (_g *ItemGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*ItemQuery, *ItemGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *ItemSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*ItemQuery, *ItemSelect](ctx, _s.ItemQuery, _s, _s.QueryState.Inters, v)
}
...
// cloneEagerLoadersItem returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersItem(in map[string]func(context.Context, []*Item) error) map[string]func(context.Context, []*Item) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Item) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

...
func (_q *ItemQuery) All(ctx context.Context) ([]*Item, error) {
	nodes, err := entbuilder.RunAll[[]*Item](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Item, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

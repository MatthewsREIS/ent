...
const (
	...
	// TypeGroup holds the string denoting the group type in the database.
	TypeGroup = "Group"
)
...
var schemaGraph = func() *sqlgraph.Schema {
	...
	graph.Nodes[0] = &sqlgraph.Node{
		...
		Fields: map[string]*sqlgraph.FieldSpec{
			...
			FieldExpire:   {Type: field.TypeTime, Column: FieldExpire},
			FieldType:     {Type: field.TypeString, Column: FieldType},
			FieldMaxUsers: {Type: field.TypeInt, Column: FieldMaxUsers},
	...
	graph.Nodes[3] = &sqlgraph.Node{Type: "GroupInfo"}
	graph.MustAddE(
		"files",
		&sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,

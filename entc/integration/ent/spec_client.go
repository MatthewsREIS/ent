...
func (c *SpecClient) Update() *spec.SpecUpdate {
	mutation := NewSpecMutation(c.Config, OpUpdate, WithSpecIDsFunc(func(ctx context.Context, ps ...predicate.Spec) ([]int, error) {
...
func (c *SpecClient) UpdateOneID(id int) *spec.SpecUpdateOne {
...
func (c *SpecClient) Delete() *spec.SpecDelete {
	mutation := NewSpecMutation(c.Config, OpDelete, WithSpecIDsFunc(func(ctx context.Context, ps ...predicate.Spec) ([]int, error) {
		return c.Query().Where(ps...).IDs(ctx)
	}))

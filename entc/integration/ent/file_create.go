...
var fileCreateDescriptor = entbuilder.CreateDescriptor[config, File, *FileMutation]{
	...
	Fields: []entbuilder.FieldDescriptor[config, File, *FileMutation]{
		...
		entbuilder.SimpleField[config, File, *FileMutation, int](
			file.FieldSetID,
			field.TypeInt,
			(*FileMutation).SetID,
			func(n *File, v int) { n.SetID = v },
		),
		...
		entbuilder.NillableField[config, File, *FileMutation, string](
			file.FieldUser,
			field.TypeString,
			(*FileMutation).User,
			func(n *File, v *string) { n.User = v },
		),
		...
		entbuilder.SimpleField[config, File, *FileMutation, string](
			...
			field.TypeString,
			(*FileMutation).Group,
			func(n *File, v string) { n.Group = v },
		),
		...
		entbuilder.SimpleField[config, File, *FileMutation, bool](
			...
			field.TypeBool,
			(*FileMutation).GetOp,
			func(n *File, v bool) { n.Op = v },
		),

		entbuilder.SimpleField[config, File, *FileMutation, int](
			file.FieldFieldID,
			field.TypeInt,
			(*FileMutation).FieldID,
			func(n *File, v int) { n.FieldID = v },
		),

		entbuilder.SimpleField[config, File, *FileMutation, time.Time](
			file.FieldCreateTime,
			field.TypeTime,
			(*FileMutation).CreateTime,
			func(n *File, v time.Time) { n.CreateTime = v },
		),
	},

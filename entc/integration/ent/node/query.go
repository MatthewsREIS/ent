...
func (_q *NodeQuery) All(ctx context.Context) ([]*Node, error) {
	nodes, err := entbuilder.RunAll[[]*Node](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Node, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

...
type NodeQuery struct {
	Config
	entbuilder.QueryState[predicate.Node]
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Node) error
	withFKs      bool
...
func (_q *NodeQuery) StoreEager(name string, loader func(context.Context, []*Node) error) *NodeQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Node) error)
	}
...
func (_q *NodeQuery) EagerLoaders() map[string]func(context.Context, []*Node) error {
...
func (_q *NodeQuery) Order(o ...OrderOption) *NodeQuery {
...
func (_q *NodeQuery) First(ctx context.Context) (*Node, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Node, []*Node](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Node, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *NodeQuery) Only(ctx context.Context) (*Node, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Node, []*Node](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Node, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *NodeQuery) All(ctx context.Context) ([]*Node, error) {
	return entbuilder.RunAll[[]*Node](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Node, error) { return _q.sqlAll(ctx) })
}
...
func (_q *NodeQuery) Clone() *NodeQuery {
	...
	return &NodeQuery{
		...
		eagerLoaders: cloneEagerLoadersNode(_q.eagerLoaders),
...
// dispatch loop.
func (_q *NodeQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Node, error) {
	var (
		nodes       = []*Node{}
		withFKs     = _q.withFKs
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
			_q.eagerLoaders["prev"] != nil,
			_q.eagerLoaders["next"] != nil,
		}
	)
	if _q.eagerLoaders["prev"] != nil {
		withFKs = true
	}
	if withFKs {
...
func (_q *NodeQuery) IncludeForeignKeys(b bool) *NodeQuery {
	_q.withFKs = b
	return _q
}
...
func (_g *NodeGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*NodeQuery, *NodeGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *NodeSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*NodeQuery, *NodeSelect](ctx, _s.NodeQuery, _s, _s.QueryState.Inters, v)
}
...
// cloneEagerLoadersNode returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersNode(in map[string]func(context.Context, []*Node) error) map[string]func(context.Context, []*Node) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Node) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

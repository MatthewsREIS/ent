...
var schemaGraph = func() *sqlgraph.Schema {
	...
	graph.Nodes[0] = &sqlgraph.Node{
		...
		Fields: map[string]*sqlgraph.FieldSpec{
			FieldUniqueInt:   {Type: field.TypeInt, Column: FieldUniqueInt},
			FieldUniqueFloat: {Type: field.TypeFloat64, Column: FieldUniqueFloat},
			FieldNillableInt: {Type: field.TypeInt, Column: FieldNillableInt},
			FieldTable:       {Type: field.TypeString, Column: FieldTable},
			FieldDir:         {Type: field.TypeJSON, Column: FieldDir},
			FieldClient:      {Type: field.TypeString, Column: FieldClient},
		},
	}
	return graph
}()

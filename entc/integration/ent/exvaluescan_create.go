...
var exvaluescanCreateDescriptor = entbuilder.CreateDescriptor[config, ExValueScan, *ExValueScanMutation]{
	...
	ID: &entbuilder.IDDescriptor[config, ExValueScan, *ExValueScanMutation]{
		...
		AssignGenerated: func(node *ExValueScan, value driver.Value) error {
			...
			default:
				...
				return fmt.Errorf("unexpected ExValueScan.ID type: %T", value)
			}
			return nil
		},
	},
	...
	Fields: []entbuilder.FieldDescriptor[config, ExValueScan, *ExValueScanMutation]{
		...
		entbuilder.FieldWithScanner[config, ExValueScan, *ExValueScanMutation, *url.URL](
		...
		entbuilder.FieldWithScanner[config, ExValueScan, *ExValueScanMutation, *big.Int](
		...
		entbuilder.FieldWithScanner[config, ExValueScan, *ExValueScanMutation, string](
...
func (_c *ExValueScanCreateBulk) Save(ctx context.Context) ([]*ExValueScan, error) {
	...
	for i := range _c.builders {
		if err := entgen.ApplyDefaults(_c.builders[i].mutation, exvaluescanCreateSpec.Fields); err != nil {
			return nil, err
		}
	}
	for i := range _c.builders {

...
func (_q *FileQuery) All(ctx context.Context) ([]*File, error) {
	return entbuilder.RunAll[[]*File](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*File, error) { return _q.sqlAll(ctx) })
}
...
func (_q *FileQuery) IncludeForeignKeys(b bool) *FileQuery {
	_q.withFKs = b
	return _q
}

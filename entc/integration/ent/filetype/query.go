...
func (_q *FileTypeQuery) All(ctx context.Context) ([]*FileType, error) {
	nodes, err := entbuilder.RunAll[[]*FileType](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*FileType, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

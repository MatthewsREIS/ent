...
type FileTypeQuery struct {
	Config
	entbuilder.QueryState[predicate.FileType]
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*FileType) error
...
func (_q *FileTypeQuery) StoreEager(name string, loader func(context.Context, []*FileType) error) *FileTypeQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*FileType) error)
	}
...
func (_q *FileTypeQuery) EagerLoaders() map[string]func(context.Context, []*FileType) error {
...
func (_q *FileTypeQuery) Order(o ...OrderOption) *FileTypeQuery {
...
func (_q *FileTypeQuery) First(ctx context.Context) (*FileType, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*FileType, []*FileType](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*FileType, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *FileTypeQuery) Only(ctx context.Context) (*FileType, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*FileType, []*FileType](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*FileType, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *FileTypeQuery) All(ctx context.Context) ([]*FileType, error) {
	return entbuilder.RunAll[[]*FileType](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*FileType, error) { return _q.sqlAll(ctx) })
}
...
func (_q *FileTypeQuery) Clone() *FileTypeQuery {
	...
	return &FileTypeQuery{
		...
		eagerLoaders: cloneEagerLoadersFileType(_q.eagerLoaders),
...
// dispatch loop.
func (_q *FileTypeQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*FileType, error) {
	var (
		nodes       = []*FileType{}
		_spec       = _q.querySpec()
		loadedTypes = [1]bool{
...
func (_q *FileTypeQuery) IncludeForeignKeys(bool) *FileTypeQuery {
	return _q
}
...
func (_g *FileTypeGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*FileTypeQuery, *FileTypeGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *FileTypeSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*FileTypeQuery, *FileTypeSelect](ctx, _s.FileTypeQuery, _s, _s.QueryState.Inters, v)
}
...
// cloneEagerLoadersFileType returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersFileType(in map[string]func(context.Context, []*FileType) error) map[string]func(context.Context, []*FileType) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*FileType) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

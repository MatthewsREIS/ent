...
func (_q *GoodsQuery) All(ctx context.Context) ([]*Goods, error) {
	nodes, err := entbuilder.RunAll[[]*Goods](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Goods, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

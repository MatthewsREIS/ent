...
type GoodsQuery struct {
	Config
	entbuilder.QueryState[predicate.Goods]
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Goods) error
...
func (_q *GoodsQuery) StoreEager(name string, loader func(context.Context, []*Goods) error) *GoodsQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Goods) error)
	}
...
func (_q *GoodsQuery) EagerLoaders() map[string]func(context.Context, []*Goods) error {
...
func (_q *GoodsQuery) Order(o ...OrderOption) *GoodsQuery {
...
func (_q *GoodsQuery) First(ctx context.Context) (*Goods, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Goods, []*Goods](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Goods, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *GoodsQuery) Only(ctx context.Context) (*Goods, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Goods, []*Goods](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Goods, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *GoodsQuery) All(ctx context.Context) ([]*Goods, error) {
	return entbuilder.RunAll[[]*Goods](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Goods, error) { return _q.sqlAll(ctx) })
}
...
func (_q *GoodsQuery) Clone() *GoodsQuery {
	...
	return &GoodsQuery{
		...
		eagerLoaders: cloneEagerLoadersGoods(_q.eagerLoaders),
...
// dispatch loop.
func (_q *GoodsQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Goods, error) {
	var (
		nodes = []*Goods{}
		_spec = _q.querySpec()
	)
...
func (_q *GoodsQuery) IncludeForeignKeys(bool) *GoodsQuery {
	return _q
}
...
func (_g *GoodsGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*GoodsQuery, *GoodsGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *GoodsSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*GoodsQuery, *GoodsSelect](ctx, _s.GoodsQuery, _s, _s.QueryState.Inters, v)
}
...
// cloneEagerLoadersGoods returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersGoods(in map[string]func(context.Context, []*Goods) error) map[string]func(context.Context, []*Goods) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Goods) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

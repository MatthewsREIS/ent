...
func (_q *TaskQuery) First(ctx context.Context) (*Task, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Task, []*Task](ctx, _q, _q.Ctx, ent.OpQueryFirst, enttask.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Task, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *TaskQuery) Only(ctx context.Context) (*Task, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Task, []*Task](ctx, _q, _q.Ctx, ent.OpQueryOnly, enttask.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Task, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}

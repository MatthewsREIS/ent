...
var userCreateDescriptor = entbuilder.CreateDescriptor[config, User, *UserMutation]{
	...
	Fields: []entbuilder.FieldDescriptor[config, User, *UserMutation]{
		...
		entbuilder.SimpleField[config, User, *UserMutation, int](
			user.FieldOptionalInt,
			field.TypeInt,
			(*UserMutation).OptionalInt,
			func(n *User, v int) { n.OptionalInt = v },
		),
		...
		entbuilder.SimpleField[config, User, *UserMutation, user.Role](
			user.FieldRole,
			field.TypeEnum,
			(*UserMutation).Role,
			func(n *User, v user.Role) { n.Role = v },
		),

		entbuilder.SimpleField[config, User, *UserMutation, user.Employment](
			user.FieldEmployment,
			field.TypeEnum,
			(*UserMutation).Employment,
			func(n *User, v user.Employment) { n.Employment = v },
		),

		entbuilder.SimpleField[config, User, *UserMutation, string](
			user.FieldSSOCert,
			field.TypeString,
			(*UserMutation).SSOCert,
			func(n *User, v string) { n.SSOCert = v },
		),

		entbuilder.SimpleField[config, User, *UserMutation, int](
			user.FieldFilesCount,
			field.TypeInt,
			(*UserMutation).FilesCount,
			func(n *User, v int) { n.FilesCount = v },
		),
	},

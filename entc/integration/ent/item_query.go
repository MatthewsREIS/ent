...
func (_q *ItemQuery) First(ctx context.Context) (*Item, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Item, []*Item](ctx, _q, _q.Ctx, ent.OpQueryFirst, item.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Item, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *ItemQuery) Only(ctx context.Context) (*Item, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Item, []*Item](ctx, _q, _q.Ctx, ent.OpQueryOnly, item.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Item, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}

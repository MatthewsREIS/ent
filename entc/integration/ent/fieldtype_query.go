...
func (_q *FieldTypeQuery) First(ctx context.Context) (*FieldType, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*FieldType, []*FieldType](ctx, _q, _q.Ctx, ent.OpQueryFirst, fieldtype.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*FieldType, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *FieldTypeQuery) FirstID(ctx context.Context) (id int, err error) {
	...
	if len(ids) == 0 {
		err = &NotFoundError{Label: fieldtype.Label}
		return
	}
	return ids[0], nil
}
...
func (_q *FieldTypeQuery) Only(ctx context.Context) (*FieldType, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*FieldType, []*FieldType](ctx, _q, _q.Ctx, ent.OpQueryOnly, fieldtype.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*FieldType, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *FieldTypeQuery) OnlyID(ctx context.Context) (id int, err error) {
	...
	case 0:
		err = &NotFoundError{Label: fieldtype.Label}
	default:
		err = &NotSingularError{Label: fieldtype.Label}
	}
	return
}

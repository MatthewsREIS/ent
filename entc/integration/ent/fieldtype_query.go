...
func (_q *FieldTypeQuery) First(ctx context.Context) (*FieldType, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{Label: fieldtype.Label}
	}
	return nodes[0], nil
}
...
func (_q *FieldTypeQuery) Only(ctx context.Context) (*FieldType, error) {
	...
	case 0:
		return nil, &NotFoundError{Label: fieldtype.Label}
	default:
		return nil, &NotSingularError{Label: fieldtype.Label}
	}
}
...
func (_q *FieldTypeQuery) OnlyIDX(ctx context.Context) int { return entbuilder.Must(_q.OnlyID(ctx)) }
...
func (_q *FieldTypeQuery) IDsX(ctx context.Context) []int { return entbuilder.Must(_q.IDs(ctx)) }

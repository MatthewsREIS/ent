...
type BuilderQuery struct {
	...
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Builder) error
...
func (_q *BuilderQuery) StoreEager(name string, loader func(context.Context, []*Builder) error) *BuilderQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Builder) error)
	}
...
func (_q *BuilderQuery) EagerLoaders() map[string]func(context.Context, []*Builder) error {
...
func (_q *BuilderQuery) Order(o ...OrderOption) *BuilderQuery {
...
func (_q *BuilderQuery) First(ctx context.Context) (*Builder, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Builder, []*Builder](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Builder, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *BuilderQuery) Only(ctx context.Context) (*Builder, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Builder, []*Builder](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Builder, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *BuilderQuery) All(ctx context.Context) ([]*Builder, error) {
	nodes, err := entbuilder.RunAll[[]*Builder](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Builder, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (_q *BuilderQuery) Clone() *BuilderQuery {
	...
	return &BuilderQuery{
		...
		eagerLoaders: cloneEagerLoadersBuilder(_q.eagerLoaders),
...
func (_q *BuilderQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Builder, error) {
...
// cloneEagerLoadersBuilder returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersBuilder(in map[string]func(context.Context, []*Builder) error) map[string]func(context.Context, []*Builder) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Builder) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

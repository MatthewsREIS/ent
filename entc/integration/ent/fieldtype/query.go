...
type FieldTypeQuery struct {
	Config
	entbuilder.QueryState[predicate.FieldType]
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*FieldType) error
	withFKs      bool
...
func (_q *FieldTypeQuery) StoreEager(name string, loader func(context.Context, []*FieldType) error) *FieldTypeQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*FieldType) error)
	}
...
func (_q *FieldTypeQuery) EagerLoaders() map[string]func(context.Context, []*FieldType) error {
...
func (_q *FieldTypeQuery) Order(o ...OrderOption) *FieldTypeQuery {
...
func (_q *FieldTypeQuery) First(ctx context.Context) (*FieldType, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*FieldType, []*FieldType](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*FieldType, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *FieldTypeQuery) Only(ctx context.Context) (*FieldType, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*FieldType, []*FieldType](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*FieldType, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *FieldTypeQuery) All(ctx context.Context) ([]*FieldType, error) {
	return entbuilder.RunAll[[]*FieldType](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*FieldType, error) { return _q.sqlAll(ctx) })
}
...
func (_q *FieldTypeQuery) Clone() *FieldTypeQuery {
	...
	return &FieldTypeQuery{
		...
		eagerLoaders: cloneEagerLoadersFieldType(_q.eagerLoaders),
...
// dispatch loop.
func (_q *FieldTypeQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*FieldType, error) {
	var (
		nodes   = []*FieldType{}
		withFKs = _q.withFKs
		_spec   = _q.querySpec()
...
func (_q *FieldTypeQuery) IncludeForeignKeys(b bool) *FieldTypeQuery {
	_q.withFKs = b
	return _q
}
...
func (_g *FieldTypeGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*FieldTypeQuery, *FieldTypeGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *FieldTypeSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*FieldTypeQuery, *FieldTypeSelect](ctx, _s.FieldTypeQuery, _s, _s.QueryState.Inters, v)
}
...
// cloneEagerLoadersFieldType returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersFieldType(in map[string]func(context.Context, []*FieldType) error) map[string]func(context.Context, []*FieldType) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*FieldType) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

...
func (_q *FieldTypeQuery) All(ctx context.Context) ([]*FieldType, error) {
	nodes, err := entbuilder.RunAll[[]*FieldType](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*FieldType, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

...
var groupCreateDescriptor = entbuilder.CreateDescriptor[config, Group, *GroupMutation]{
	...
	Fields: []entbuilder.FieldDescriptor[config, Group, *GroupMutation]{
		...
		entbuilder.SimpleField[config, Group, *GroupMutation, bool](
			group.FieldActive,
			field.TypeBool,
			(*GroupMutation).Active,
			func(n *Group, v bool) { n.Active = v },
		),

		entbuilder.SimpleField[config, Group, *GroupMutation, time.Time](
			group.FieldExpire,
			field.TypeTime,
			(*GroupMutation).Expire,
			func(n *Group, v time.Time) { n.Expire = v },
		),

		entbuilder.NillableField[config, Group, *GroupMutation, string](
			group.FieldType,
			field.TypeString,
			(*GroupMutation).GetType,
			func(n *Group, v *string) { n.Type = v },
		),

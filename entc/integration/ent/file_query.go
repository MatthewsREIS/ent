...
func (_q *FileQuery) First(ctx context.Context) (*File, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*File, []*File](ctx, _q, _q.Ctx, ent.OpQueryFirst, file.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*File, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *FileQuery) Only(ctx context.Context) (*File, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*File, []*File](ctx, _q, _q.Ctx, ent.OpQueryOnly, file.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*File, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}

...
// WithPetTeam eager-loads the "team" edge on a PetQuery. The
// optional arguments configure the sibling sub-query before storage.
func WithPetTeam(q *PetQuery, opts ...func(*UserQuery)) *PetQuery {
...
// QueryPetTeam returns a UserQuery for the "team" edge of a given Pet.
func QueryPetTeam(c *PetClient, _m *Pet) *UserQuery {

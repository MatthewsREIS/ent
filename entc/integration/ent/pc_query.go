...
func (_q *PCQuery) First(ctx context.Context) (*PC, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*PC, []*PC](ctx, _q, _q.Ctx, ent.OpQueryFirst, pc.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*PC, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *PCQuery) Only(ctx context.Context) (*PC, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*PC, []*PC](ctx, _q, _q.Ctx, ent.OpQueryOnly, pc.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*PC, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}

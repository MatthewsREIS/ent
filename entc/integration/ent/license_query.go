...
func (_q *LicenseQuery) First(ctx context.Context) (*License, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*License, []*License](ctx, _q, _q.Ctx, ent.OpQueryFirst, license.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*License, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *LicenseQuery) Only(ctx context.Context) (*License, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*License, []*License](ctx, _q, _q.Ctx, ent.OpQueryOnly, license.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*License, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}

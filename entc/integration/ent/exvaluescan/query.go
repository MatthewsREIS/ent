...
func (_q *ExValueScanQuery) All(ctx context.Context) ([]*ExValueScan, error) {
	return entbuilder.RunAll[[]*ExValueScan](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*ExValueScan, error) { return _q.sqlAll(ctx) })
}
...
func (_q *ExValueScanQuery) IncludeForeignKeys(bool) *ExValueScanQuery {
	return _q
}

...
var schemaGraph = func() *sqlgraph.Schema {
	...
	graph.Nodes[0] = &sqlgraph.Node{
		...
		Fields: map[string]*sqlgraph.FieldSpec{
			FieldPriority:    {Type: field.TypeInt, Column: FieldPriority},
			FieldPriorities:  {Type: field.TypeJSON, Column: FieldPriorities},
			FieldCreatedAt:   {Type: field.TypeTime, Column: FieldCreatedAt},
			FieldName:        {Type: field.TypeString, Column: FieldName},
			FieldOwner:       {Type: field.TypeString, Column: FieldOwner},
			FieldOrder:       {Type: field.TypeInt, Column: FieldOrder},
			FieldOrderOption: {Type: field.TypeInt, Column: FieldOrderOption},
			FieldOp:          {Type: field.TypeString, Column: FieldOp},
		},
	}
	return graph
}()

...
func (_q *PCQuery) All(ctx context.Context) ([]*PC, error) {
	return entbuilder.RunAll[[]*PC](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*PC, error) { return _q.sqlAll(ctx) })
}
...
func (_q *PCQuery) IncludeForeignKeys(bool) *PCQuery {
	return _q
}

...
func (_q *LicenseQuery) All(ctx context.Context) ([]*License, error) {
	nodes, err := entbuilder.RunAll[[]*License](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*License, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

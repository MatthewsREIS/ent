...
type LicenseQuery struct {
	Config
	entbuilder.QueryState[predicate.License]
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*License) error
...
func (_q *LicenseQuery) StoreEager(name string, loader func(context.Context, []*License) error) *LicenseQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*License) error)
	}
...
func (_q *LicenseQuery) EagerLoaders() map[string]func(context.Context, []*License) error {
...
func (_q *LicenseQuery) Order(o ...OrderOption) *LicenseQuery {
...
func (_q *LicenseQuery) First(ctx context.Context) (*License, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*License, []*License](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*License, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *LicenseQuery) Only(ctx context.Context) (*License, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*License, []*License](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*License, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *LicenseQuery) All(ctx context.Context) ([]*License, error) {
	return entbuilder.RunAll[[]*License](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*License, error) { return _q.sqlAll(ctx) })
}
...
func (_q *LicenseQuery) Clone() *LicenseQuery {
	...
	return &LicenseQuery{
		...
		eagerLoaders: cloneEagerLoadersLicense(_q.eagerLoaders),
...
// dispatch loop.
func (_q *LicenseQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*License, error) {
	var (
		nodes = []*License{}
		_spec = _q.querySpec()
	)
...
func (_q *LicenseQuery) IncludeForeignKeys(bool) *LicenseQuery {
	return _q
}
...
func (_g *LicenseGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*LicenseQuery, *LicenseGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *LicenseSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*LicenseQuery, *LicenseSelect](ctx, _s.LicenseQuery, _s, _s.QueryState.Inters, v)
}
...
// cloneEagerLoadersLicense returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersLicense(in map[string]func(context.Context, []*License) error) map[string]func(context.Context, []*License) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*License) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

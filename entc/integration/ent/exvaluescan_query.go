...
func (_q *ExValueScanQuery) First(ctx context.Context) (*ExValueScan, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*ExValueScan, []*ExValueScan](ctx, _q, _q.Ctx, ent.OpQueryFirst, exvaluescan.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*ExValueScan, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}

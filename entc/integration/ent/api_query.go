...
func (_q *APIQuery) OnlyIDX(ctx context.Context) int { return entbuilder.Must(_q.OnlyID(ctx)) }
...
func (_q *APIQuery) IDsX(ctx context.Context) []int { return entbuilder.Must(_q.IDs(ctx)) }

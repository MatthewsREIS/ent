...
func (_q *ParentQuery) First(ctx context.Context) (*Parent, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Parent, []*Parent](ctx, _q, _q.Ctx, ent.OpQueryFirst, parent.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Parent, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *ParentQuery) Only(ctx context.Context) (*Parent, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Parent, []*Parent](ctx, _q, _q.Ctx, ent.OpQueryOnly, parent.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Parent, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}

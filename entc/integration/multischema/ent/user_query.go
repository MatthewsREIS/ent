...
var userParentsEdgeLoadDescriptor = entbuilder.EdgeLoadDescriptor[User, User, int, int]{
	EdgeSpec: func() *sqlgraph.EdgeSpec {
		return entbuilder.NewEdgeSpec(entbuilder.EdgeSpecParams{
			Rel:          sqlgraph.M2M,
			Inverse:      true,
...
var userParentHoodEdgeLoadDescriptor = entbuilder.EdgeLoadDescriptor[User, Parent, int, int]{
	EdgeSpec: func() *sqlgraph.EdgeSpec {
		return entbuilder.NewEdgeSpec(entbuilder.EdgeSpecParams{
			Rel:          sqlgraph.O2M,
			Inverse:      true,
			Table:        user.ParentHoodTable,
			Columns:      user.ParentHoodColumn,
			Bidi:         false,
			TargetColumn: parent.FieldID,
			TargetType:   field.TypeInt,
		})
	},
	ExtractNodeID: func(n *User) int { return n.ID },
	ExtractEdgeID: func(e *Parent) int { return e.ID },
	ExtractEdgeFK: func(e *Parent) *int {
		v := e.UserID
		return &v
	},
}
...
func (_q *UserQuery) loadGroups(ctx context.Context, query *GroupQuery, nodes []*User, init func(*User), assign func(*User, *Group)) error {
	return entbuilder.LoadEdgeM2M(ctx, &userGroupsEdgeLoadDescriptor, nodes, init, assign, [2]int{1, 0},
		func(fn func(*sql.Selector)) { query.Where(fn) },
		query.prepareQuery,
...
func (_q *UserQuery) loadParents(ctx context.Context, query *UserQuery, nodes []*User, init func(*User), assign func(*User, *User)) error {
	return entbuilder.LoadEdgeM2M(ctx, &userParentsEdgeLoadDescriptor, nodes, init, assign, [2]int{1, 0},
		func(fn func(*sql.Selector)) { query.Where(fn) },
		query.prepareQuery,
		func(ctx context.Context, modifiers ...func(context.Context, *sqlgraph.QuerySpec)) ([]*User, error) {
			hooks := make([]queryHook, len(modifiers))
...
func (_q *UserQuery) loadChildren(ctx context.Context, query *UserQuery, nodes []*User, init func(*User), assign func(*User, *User)) error {
	return entbuilder.LoadEdgeM2M(ctx, &userChildrenEdgeLoadDescriptor, nodes, init, assign, [2]int{0, 1},
		func(fn func(*sql.Selector)) { query.Where(fn) },
		query.prepareQuery,
		func(ctx context.Context, modifiers ...func(context.Context, *sqlgraph.QuerySpec)) ([]*User, error) {
			hooks := make([]queryHook, len(modifiers))
...
func (_q *UserQuery) loadParentHood(ctx context.Context, query *ParentQuery, nodes []*User, init func(*User), assign func(*User, *Parent)) error {
	...
	return entbuilder.LoadEdgeO2M(ctx, &userParentHoodEdgeLoadDescriptor, nodes, init, assign,
		func(bool) {},
		func(fn func(*sql.Selector)) { query.Where(fn) },
		query.All)
	return nil

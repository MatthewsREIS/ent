...
const (
	...
	// TypeParent holds the string denoting the parent type in the database.
	TypeParent = "Parent"
)
...
type Parent = internal.Parent
type ParentEdges = internal.ParentEdges
type Parents = internal.Parents

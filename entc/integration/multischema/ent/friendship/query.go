...
type FriendshipQuery struct {
	Config
	entbuilder.QueryState[predicate.Friendship]
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Friendship) error
...
func (_q *FriendshipQuery) StoreEager(name string, loader func(context.Context, []*Friendship) error) *FriendshipQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Friendship) error)
	}
...
func (_q *FriendshipQuery) EagerLoaders() map[string]func(context.Context, []*Friendship) error {
...
func (_q *FriendshipQuery) Order(o ...OrderOption) *FriendshipQuery {
...
func (_q *FriendshipQuery) First(ctx context.Context) (*Friendship, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Friendship, []*Friendship](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Friendship, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *FriendshipQuery) Only(ctx context.Context) (*Friendship, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Friendship, []*Friendship](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Friendship, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *FriendshipQuery) All(ctx context.Context) ([]*Friendship, error) {
	return entbuilder.RunAll[[]*Friendship](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Friendship, error) { return _q.sqlAll(ctx) })
}
...
func (_q *FriendshipQuery) Clone() *FriendshipQuery {
	...
	return &FriendshipQuery{
		...
		eagerLoaders: cloneEagerLoadersFriendship(_q.eagerLoaders),
...
// dispatch loop.
func (_q *FriendshipQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Friendship, error) {
	var (
		nodes       = []*Friendship{}
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
			_q.eagerLoaders["user"] != nil,
			_q.eagerLoaders["friend"] != nil,
		}
	)
...
func (_q *FriendshipQuery) IncludeForeignKeys(bool) *FriendshipQuery {
	return _q
}
...
func (_q *FriendshipQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.Ctx.Fields; len(fields) > 0 {
		...
		if _, ok := _q.eagerLoaders["friend"]; ok {
			_spec.Node.AddColumnOnce(FieldFriendID)
		}
	}
...
func (_q *FriendshipQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	schemaConfig := _q.Config.SchemaConfig()
	t1.Schema(schemaConfig.Friendship)
	ctx = internal.NewSchemaConfigContext(ctx, schemaConfig)
...
func (_g *FriendshipGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*FriendshipQuery, *FriendshipGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *FriendshipSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*FriendshipQuery, *FriendshipSelect](ctx, _s.FriendshipQuery, _s, _s.QueryState.Inters, v)
}
...
// cloneEagerLoadersFriendship returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersFriendship(in map[string]func(context.Context, []*Friendship) error) map[string]func(context.Context, []*Friendship) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Friendship) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

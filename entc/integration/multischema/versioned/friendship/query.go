...
func (_q *FriendshipQuery) All(ctx context.Context) ([]*Friendship, error) {
	nodes, err := entbuilder.RunAll[[]*Friendship](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Friendship, error) { return _q.sqlAll(ctx) })
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {

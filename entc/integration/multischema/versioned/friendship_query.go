...
func (_q *FriendshipQuery) First(ctx context.Context) (*Friendship, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Friendship, []*Friendship](ctx, _q, _q.Ctx, ent.OpQueryFirst, friendship.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Friendship, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *FriendshipQuery) Only(ctx context.Context) (*Friendship, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Friendship, []*Friendship](ctx, _q, _q.Ctx, ent.OpQueryOnly, friendship.Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Friendship, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}

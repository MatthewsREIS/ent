...
func (_q *FriendshipQuery) Limit(limit int) *FriendshipQuery { _q.ctx.Limit = &limit; return _q }

// Offset to start from.
func (_q *FriendshipQuery) Offset(offset int) *FriendshipQuery { _q.ctx.Offset = &offset; return _q }

// Unique configures the query builder to filter duplicate records on query.
// By default, unique is set to true, and can be disabled using this method.
func (_q *FriendshipQuery) Unique(unique bool) *FriendshipQuery { _q.ctx.Unique = &unique; return _q }
...
func (_q *FriendshipQuery) OnlyIDX(ctx context.Context) int { return entbuilder.Must(_q.OnlyID(ctx)) }
...
func (_q *FriendshipQuery) IDsX(ctx context.Context) []int { return entbuilder.Must(_q.IDs(ctx)) }
...
func (_q *FriendshipQuery) CountX(ctx context.Context) int { return entbuilder.Must(_q.Count(ctx)) }
...
func (_q *FriendshipQuery) ExistX(ctx context.Context) bool { return entbuilder.Must(_q.Exist(ctx)) }

...
type SessionDeviceQuery struct {
	Config
	entbuilder.QueryState[predicate.SessionDevice]
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*SessionDevice) error
}
...
func (_q *SessionDeviceQuery) StoreEager(name string, loader func(context.Context, []*SessionDevice) error) *SessionDeviceQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*SessionDevice) error)
	}
...
func (_q *SessionDeviceQuery) EagerLoaders() map[string]func(context.Context, []*SessionDevice) error {
...
func (_q *SessionDeviceQuery) Order(o ...OrderOption) *SessionDeviceQuery {
...
func (_q *SessionDeviceQuery) First(ctx context.Context) (*SessionDevice, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*SessionDevice, []*SessionDevice](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*SessionDevice, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *SessionDeviceQuery) Only(ctx context.Context) (*SessionDevice, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*SessionDevice, []*SessionDevice](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*SessionDevice, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *SessionDeviceQuery) All(ctx context.Context) ([]*SessionDevice, error) {
	return entbuilder.RunAll[[]*SessionDevice](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*SessionDevice, error) { return _q.sqlAll(ctx) })
}
...
func (_q *SessionDeviceQuery) Clone() *SessionDeviceQuery {
	...
	return &SessionDeviceQuery{
		...
		eagerLoaders: cloneEagerLoadersSessionDevice(_q.eagerLoaders),
	}
}
...
// dispatch loop.
func (_q *SessionDeviceQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*SessionDevice, error) {
	var (
		nodes       = []*SessionDevice{}
		_spec       = _q.querySpec()
		loadedTypes = [1]bool{
			_q.eagerLoaders["sessions"] != nil,
		}
	)
...
func (_q *SessionDeviceQuery) IncludeForeignKeys(bool) *SessionDeviceQuery {
	return _q
}
...
func (_g *SessionDeviceGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*SessionDeviceQuery, *SessionDeviceGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *SessionDeviceSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*SessionDeviceQuery, *SessionDeviceSelect](ctx, _s.SessionDeviceQuery, _s, _s.QueryState.Inters, v)
}
...
// sessiondeviceCreateDescriptor holds the metadata and callbacks for constructing a SessionDevice entity.
var sessiondeviceCreateDescriptor = &entbuilder.CreateDescriptor[Config, SessionDevice, *SessionDeviceMutation]{
	Table:   Table,
	NewNode: func(c Config) *SessionDevice { return &SessionDevice{Config: c} },
	ID: &entbuilder.IDDescriptor[Config, SessionDevice, *SessionDeviceMutation]{
		...
		AssignNode: func(n *SessionDevice, fv entbuilder.FieldValue) error {
			n.ID = fv.Node.(uuid.UUID)
			return nil
		},
		AssignGenerated: func(n *SessionDevice, v driver.Value) error {
			switch x := v.(type) {
			case uuid.UUID:
				n.ID = x
			default:
				return fmt.Errorf("unexpected SessionDevice.ID type: %T", v)
			}
			return nil
		},
	},
...
// cloneEagerLoadersSessionDevice returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersSessionDevice(in map[string]func(context.Context, []*SessionDevice) error) map[string]func(context.Context, []*SessionDevice) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*SessionDevice) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

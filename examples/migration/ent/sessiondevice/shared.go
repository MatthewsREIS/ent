...
const (
	...
	// TypeSessionDevice holds the string denoting the sessiondevice type in the database.
...
type SessionDevice = internal.SessionDevice
type SessionDeviceEdges = internal.SessionDeviceEdges
type SessionDevices = internal.SessionDevices

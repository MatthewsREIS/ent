...
import (
	"entgo.io/ent/examples/privacytenant/ent/edges"
...
// WithGroupTenant forwards to edges.WithGroupTenant — body hoisted to gen/edges/group.go for build parallelism.
var WithGroupTenant = edges.WithGroupTenant

// QueryGroupTenant forwards to edges.QueryGroupTenant.
var QueryGroupTenant = edges.QueryGroupTenant

// QueryGroupTenantFromQuery forwards to edges.QueryGroupTenantFromQuery.
var QueryGroupTenantFromQuery = edges.QueryGroupTenantFromQuery

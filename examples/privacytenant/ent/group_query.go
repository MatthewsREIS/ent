...
var groupTenantEdgeLoadDescriptor = entbuilder.EdgeLoadDescriptor[Group, Tenant, int, int]{
	EdgeSpec: func() *sqlgraph.EdgeSpec {
		return entbuilder.NewEdgeSpec(entbuilder.EdgeSpecParams{
			Rel:          sqlgraph.M2O,
			Inverse:      false,
			Table:        group.TenantTable,
			Columns:      group.TenantColumn,
			Bidi:         false,
			TargetColumn: tenant.FieldID,
			TargetType:   field.TypeInt,
		})
	},
	ExtractNodeID: func(n *Group) int { return n.ID },
	ExtractEdgeID: func(e *Tenant) int { return e.ID },
...
func (_q *GroupQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*Group, init func(*Group), assign func(*Group, *Tenant)) error {
	return entbuilder.LoadEdgeM2O(ctx, &groupTenantEdgeLoadDescriptor, nodes, assign,
		func(ids []int) {

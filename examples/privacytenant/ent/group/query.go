...
func (_q *GroupQuery) IncludeForeignKeys(bool) *GroupQuery {
	return _q
}
...
func (_q *GroupQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.Ctx.Fields; len(fields) > 0 {
		...
		if _, ok := _q.eagerLoaders["tenant"]; ok {
			_spec.Node.AddColumnOnce(FieldTenantID)
		}
	}

...
func (_u *UserUpdate) check() error {
	if _u.mutation.EdgeCleared("tenant") && len(_u.mutation.EdgeIDs("tenant")) > 0 {
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := entbuilder.GetField[[]string](_u.mutation, "foods"); ok {
		_spec.SetField(FieldFoods, field.TypeJSON, value)
	}
	if value, ok := _u.mutation.AppendedField("foods"); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, FieldFoods, value.([]string))
		})
	}
	if _u.mutation.FieldCleared("foods") {
		_spec.ClearField(FieldFoods, field.TypeJSON)
	}

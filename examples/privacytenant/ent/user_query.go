...
var userTenantEdgeLoadDescriptor = entbuilder.EdgeLoadDescriptor[User, Tenant, int, int]{
	EdgeSpec: func() *sqlgraph.EdgeSpec {
		return entbuilder.NewEdgeSpec(entbuilder.EdgeSpecParams{
			Rel:          sqlgraph.M2O,
			Inverse:      false,
			Table:        user.TenantTable,
			Columns:      user.TenantColumn,
			Bidi:         false,
...
func (_q *UserQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*User, init func(*User), assign func(*User, *Tenant)) error {
	return entbuilder.LoadEdgeM2O(ctx, &userTenantEdgeLoadDescriptor, nodes, assign,
		func(ids []int) {

...
type TenantQuery struct {
	Config
	entbuilder.QueryState[predicate.Tenant]
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*Tenant) error
}
...
func (_q *TenantQuery) StoreEager(name string, loader func(context.Context, []*Tenant) error) *TenantQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*Tenant) error)
	}
...
func (_q *TenantQuery) EagerLoaders() map[string]func(context.Context, []*Tenant) error {
...
func (_q *TenantQuery) Order(o ...OrderOption) *TenantQuery {
...
func (_q *TenantQuery) First(ctx context.Context) (*Tenant, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*Tenant, []*Tenant](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Tenant, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *TenantQuery) Only(ctx context.Context) (*Tenant, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*Tenant, []*Tenant](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Tenant, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *TenantQuery) All(ctx context.Context) ([]*Tenant, error) {
	return entbuilder.RunAll[[]*Tenant](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*Tenant, error) { return _q.sqlAll(ctx) })
}
...
func (_q *TenantQuery) Clone() *TenantQuery {
	...
	return &TenantQuery{
		...
		eagerLoaders: cloneEagerLoadersTenant(_q.eagerLoaders),
	}
}
...
// dispatch loop.
func (_q *TenantQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*Tenant, error) {
	var (
		nodes = []*Tenant{}
		_spec = _q.querySpec()
	)
...
func (_q *TenantQuery) IncludeForeignKeys(bool) *TenantQuery {
	return _q
}
...
func (_g *TenantGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*TenantQuery, *TenantGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *TenantSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*TenantQuery, *TenantSelect](ctx, _s.TenantQuery, _s, _s.QueryState.Inters, v)
}
...
// tenantCreateDescriptor holds the metadata and callbacks for constructing a Tenant entity.
var tenantCreateDescriptor = &entbuilder.CreateDescriptor[Config, Tenant, *TenantMutation]{
	Table:   Table,
	NewNode: func(c Config) *Tenant { return &Tenant{Config: c} },
	ID: &entbuilder.IDDescriptor[Config, Tenant, *TenantMutation]{
		Column:      FieldID,
		Type:        field.TypeInt,
		UserDefined: false,
		AssignGenerated: func(n *Tenant, v driver.Value) error {
			id, ok := v.(int64)
			if !ok {
				return fmt.Errorf("unexpected Tenant.ID type: %T", v)
			}
			n.ID = int(id)
			return nil
		},
...
// cloneEagerLoadersTenant returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersTenant(in map[string]func(context.Context, []*Tenant) error) map[string]func(context.Context, []*Tenant) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*Tenant) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

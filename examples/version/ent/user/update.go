...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := entbuilder.GetField[int64](_u.mutation, "version"); ok {
		_spec.SetField(FieldVersion, field.TypeInt64, value)
	}
	if added, ok := _u.mutation.AddedField("version"); ok {
		value := added.(int64)
		_spec.AddField(FieldVersion, field.TypeInt64, value)
	}

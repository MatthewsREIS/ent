...
func (e *GroupEdges) SetLoadedTypes(lt [2]bool) {
	e.loadedTypes = lt
}
...
// SetGroupAdmin sets the group_admin foreign key.
func (_m *Group) SetGroupAdmin(v int) {
	_m.group_admin = &v
}

// GetGroupAdmin returns the group_admin foreign key value.
func (_m *Group) GetGroupAdmin() *int {
	return _m.group_admin
}

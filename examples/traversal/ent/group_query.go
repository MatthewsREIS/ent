...
var groupAdminEdgeLoadDescriptor = entbuilder.EdgeLoadDescriptor[Group, User, int, int]{
	EdgeSpec: func() *sqlgraph.EdgeSpec {
		return entbuilder.NewEdgeSpec(entbuilder.EdgeSpecParams{
			Rel:          sqlgraph.M2O,
			Inverse:      false,
			Table:        group.AdminTable,
			Columns:      group.AdminColumn,
			Bidi:         false,
			TargetColumn: user.FieldID,
			TargetType:   field.TypeInt,
		})
...
func (_q *GroupQuery) loadUsers(ctx context.Context, query *UserQuery, nodes []*Group, init func(*Group), assign func(*Group, *User)) error {
	return entbuilder.LoadEdgeM2M(ctx, &groupUsersEdgeLoadDescriptor, nodes, init, assign, [2]int{0, 1},
...
func (_q *GroupQuery) loadAdmin(ctx context.Context, query *UserQuery, nodes []*Group, init func(*Group), assign func(*Group, *User)) error {
	return entbuilder.LoadEdgeM2O(ctx, &groupAdminEdgeLoadDescriptor, nodes, assign,
		func(ids []int) {

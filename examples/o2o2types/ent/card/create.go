...
func (_c *CardCreate) SetExpired(v time.Time) *CardCreate {
	_ = _c.mutation.SetField("expired", v)
	return _c
}
...
func (_c *CardCreate) check() error {
	if _, ok := entbuilder.GetField[time.Time](_c.mutation, "expired"); !ok {
...
func (_c *CardCreate) createSpec() (*Card, *sqlgraph.CreateSpec) {
	...
	if value, ok := entbuilder.GetField[time.Time](_c.mutation, "expired"); ok {
		_spec.SetField(FieldExpired, field.TypeTime, value)
		_node.Expired = value
	}

...
// NewUserAuditLogCreate returns a new UserAuditLogCreate initialized with the given config, hooks, and mutation.
func NewUserAuditLogCreate(c Config, hooks []Hook, mutation *UserAuditLogMutation) *UserAuditLogCreate {
	return &UserAuditLogCreate{Config: c, hooks: hooks, mutation: mutation}
}

// SetOperationType sets the "operation_type" field.
func (_c *UserAuditLogCreate) SetOperationType(v string) *UserAuditLogCreate {
	_ = _c.mutation.SetField("operation_type", v)
	return _c
}

// SetOperationTime sets the "operation_time" field.
func (_c *UserAuditLogCreate) SetOperationTime(v string) *UserAuditLogCreate {
	_ = _c.mutation.SetField("operation_time", v)
	return _c
}

// SetOldValue sets the "old_value" field.
func (_c *UserAuditLogCreate) SetOldValue(v string) *UserAuditLogCreate {
	_ = _c.mutation.SetField("old_value", v)
	return _c
}
...
func (_c *UserAuditLogCreate) SetNewValue(v string) *UserAuditLogCreate {
	_ = _c.mutation.SetField("new_value", v)
	return _c
}
...
func (_c *UserAuditLogCreate) check() error {
	if _, ok := entbuilder.GetField[string](_c.mutation, "operation_type"); !ok {
		return &ValidationError{Name: "operation_type", Err: errors.New(`ent: missing required field "UserAuditLog.operation_type"`)}
	}
	if _, ok := entbuilder.GetField[string](_c.mutation, "operation_time"); !ok {
...
func (_c *UserAuditLogCreate) createSpec() (*UserAuditLog, *sqlgraph.CreateSpec) {
	...
	if value, ok := entbuilder.GetField[string](_c.mutation, "operation_type"); ok {
		_spec.SetField(FieldOperationType, field.TypeString, value)
		_node.OperationType = value
	}
	if value, ok := entbuilder.GetField[string](_c.mutation, "operation_time"); ok {
		_spec.SetField(FieldOperationTime, field.TypeString, value)
		_node.OperationTime = value
	}
	if value, ok := entbuilder.GetField[string](_c.mutation, "old_value"); ok {
		_spec.SetField(FieldOldValue, field.TypeString, value)
		_node.OldValue = value
	}
	if value, ok := entbuilder.GetField[string](_c.mutation, "new_value"); ok {
...
// NewUserAuditLogCreateBulk returns a new UserAuditLogCreateBulk initialized with the given config and builders.
func NewUserAuditLogCreateBulk(c Config, builders []*UserAuditLogCreate) *UserAuditLogCreateBulk {
	return &UserAuditLogCreateBulk{Config: c, builders: builders}
}

// NewUserAuditLogCreateBulkErr returns a new UserAuditLogCreateBulk that returns the given error on Save.
func NewUserAuditLogCreateBulkErr(err error) *UserAuditLogCreateBulk {
	return &UserAuditLogCreateBulk{err: err}
}

...
type UserAuditLogQuery struct {
	Config
	entbuilder.QueryState[predicate.UserAuditLog]
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*UserAuditLog) error
}
...
func (_q *UserAuditLogQuery) StoreEager(name string, loader func(context.Context, []*UserAuditLog) error) *UserAuditLogQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*UserAuditLog) error)
	}
...
func (_q *UserAuditLogQuery) EagerLoaders() map[string]func(context.Context, []*UserAuditLog) error {
...
func (_q *UserAuditLogQuery) Order(o ...OrderOption) *UserAuditLogQuery {
...
func (_q *UserAuditLogQuery) First(ctx context.Context) (*UserAuditLog, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*UserAuditLog, []*UserAuditLog](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*UserAuditLog, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *UserAuditLogQuery) Only(ctx context.Context) (*UserAuditLog, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*UserAuditLog, []*UserAuditLog](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*UserAuditLog, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *UserAuditLogQuery) All(ctx context.Context) ([]*UserAuditLog, error) {
	return entbuilder.RunAll[[]*UserAuditLog](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*UserAuditLog, error) { return _q.sqlAll(ctx) })
}
...
func (_q *UserAuditLogQuery) Clone() *UserAuditLogQuery {
	...
	return &UserAuditLogQuery{
		...
		eagerLoaders: cloneEagerLoadersUserAuditLog(_q.eagerLoaders),
	}
}
...
// dispatch loop.
func (_q *UserAuditLogQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*UserAuditLog, error) {
	var (
		nodes = []*UserAuditLog{}
		_spec = _q.querySpec()
	)
...
func (_q *UserAuditLogQuery) IncludeForeignKeys(bool) *UserAuditLogQuery {
	return _q
}
...
func (_g *UserAuditLogGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*UserAuditLogQuery, *UserAuditLogGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *UserAuditLogSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*UserAuditLogQuery, *UserAuditLogSelect](ctx, _s.UserAuditLogQuery, _s, _s.QueryState.Inters, v)
}
...
// userauditlogCreateDescriptor holds the metadata and callbacks for constructing a UserAuditLog entity.
var userauditlogCreateDescriptor = &entbuilder.CreateDescriptor[Config, UserAuditLog, *UserAuditLogMutation]{
	Table:   Table,
	NewNode: func(c Config) *UserAuditLog { return &UserAuditLog{Config: c} },
	ID: &entbuilder.IDDescriptor[Config, UserAuditLog, *UserAuditLogMutation]{
		Column:      FieldID,
		Type:        field.TypeInt,
		UserDefined: false,
		AssignGenerated: func(n *UserAuditLog, v driver.Value) error {
			id, ok := v.(int64)
			if !ok {
				return fmt.Errorf("unexpected UserAuditLog.ID type: %T", v)
			}
			n.ID = int(id)
			return nil
		},
...
// cloneEagerLoadersUserAuditLog returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersUserAuditLog(in map[string]func(context.Context, []*UserAuditLog) error) map[string]func(context.Context, []*UserAuditLog) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*UserAuditLog) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

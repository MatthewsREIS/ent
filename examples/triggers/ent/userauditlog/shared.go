...
const (
	...
	// TypeUserAuditLog holds the string denoting the userauditlog type in the database.
...
type UserAuditLog = internal.UserAuditLog
type UserAuditLogs = internal.UserAuditLogs

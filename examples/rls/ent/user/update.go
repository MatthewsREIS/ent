...
func (_u *UserUpdate) SetTenantID(v int) *UserUpdate {
	_ = _u.mutation.ResetField("tenant_id")
	_ = _u.mutation.SetField("tenant_id", v)
	return _u
}
...
func (_u *UserUpdate) AddTenantID(v int) *UserUpdate {
	_ = _u.mutation.AddField("tenant_id", v)
	return _u
}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := entbuilder.GetField[int](_u.mutation, "tenant_id"); ok {
		_spec.SetField(FieldTenantID, field.TypeInt, value)
	}
	if added, ok := _u.mutation.AddedField("tenant_id"); ok {
		value := added.(int)
		_spec.AddField(FieldTenantID, field.TypeInt, value)
	}

...
var userCreateDescriptor = entbuilder.CreateDescriptor[config, User, *UserMutation]{
	...
	Fields: []entbuilder.FieldDescriptor[config, User, *UserMutation]{
		...
		entbuilder.SimpleField[config, User, *UserMutation, string](
			user.FieldPublicInfo,
			field.TypeString,
			(*UserMutation).PublicInfo,
			func(n *User, v string) { n.PublicInfo = v },
		),

		entbuilder.SimpleField[config, User, *UserMutation, string](
			user.FieldPrivateInfo,
			field.TypeString,
			(*UserMutation).PrivateInfo,
			func(n *User, v string) { n.PrivateInfo = v },
		),
	},
}

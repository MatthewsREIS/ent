...
var userCarsEdgeLoadDescriptor = entbuilder.EdgeLoadDescriptor[User, Car, int, int]{
	EdgeSpec: func() *sqlgraph.EdgeSpec {
		return entbuilder.NewEdgeSpec(entbuilder.EdgeSpecParams{
			Rel:          sqlgraph.O2M,
			Inverse:      false,
			Table:        user.CarsTable,
			Columns:      user.CarsColumn,
			Bidi:         false,
...
func (_q *UserQuery) loadCars(ctx context.Context, query *CarQuery, nodes []*User, init func(*User), assign func(*User, *Car)) error {
	query.withFKs = true
	return entbuilder.LoadEdgeO2M(ctx, &userCarsEdgeLoadDescriptor, nodes, init, assign,
		func(bool) {},

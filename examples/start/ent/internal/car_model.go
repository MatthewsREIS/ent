...
// SetUserCars sets the user_cars foreign key.
func (_m *Car) SetUserCars(v int) {
	_m.user_cars = &v
}

// GetUserCars returns the user_cars foreign key value.
func (_m *Car) GetUserCars() *int {
	return _m.user_cars
}

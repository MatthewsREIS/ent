...
func (_c *CarCreate) SetRegisteredAt(v time.Time) *CarCreate {
	_ = _c.mutation.SetField("registered_at", v)
	return _c
}
...
func (_c *CarCreate) check() error {
	...
	if _, ok := entbuilder.GetField[time.Time](_c.mutation, "registered_at"); !ok {
...
func (_c *CarCreate) createSpec() (*Car, *sqlgraph.CreateSpec) {
	...
	if value, ok := entbuilder.GetField[time.Time](_c.mutation, "registered_at"); ok {
		_spec.SetField(FieldRegisteredAt, field.TypeTime, value)

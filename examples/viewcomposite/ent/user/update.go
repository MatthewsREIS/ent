...
func (_u *UserUpdate) SetPublicInfo(v string) *UserUpdate {
	_ = _u.mutation.SetField("public_info", v)
	return _u
}
...
func (_u *UserUpdate) SetPrivateInfo(v string) *UserUpdate {
	_ = _u.mutation.SetField("private_info", v)
	return _u
}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := entbuilder.GetField[string](_u.mutation, "public_info"); ok {
		_spec.SetField(FieldPublicInfo, field.TypeString, value)
	}
	if value, ok := entbuilder.GetField[string](_u.mutation, "private_info"); ok {

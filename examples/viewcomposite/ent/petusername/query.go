...
type PetUserNameQuery struct {
	Config
	entbuilder.QueryState[predicate.PetUserName]
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*PetUserName) error
}
...
func (_q *PetUserNameQuery) StoreEager(name string, loader func(context.Context, []*PetUserName) error) *PetUserNameQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*PetUserName) error)
	}
...
func (_q *PetUserNameQuery) EagerLoaders() map[string]func(context.Context, []*PetUserName) error {
...
func (_q *PetUserNameQuery) Order(o ...OrderOption) *PetUserNameQuery {
...
func (_q *PetUserNameQuery) First(ctx context.Context) (*PetUserName, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*PetUserName, []*PetUserName](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*PetUserName, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *PetUserNameQuery) Only(ctx context.Context) (*PetUserName, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*PetUserName, []*PetUserName](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*PetUserName, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *PetUserNameQuery) All(ctx context.Context) ([]*PetUserName, error) {
	return entbuilder.RunAll[[]*PetUserName](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*PetUserName, error) { return _q.sqlAll(ctx) })
}
...
func (_q *PetUserNameQuery) Clone() *PetUserNameQuery {
	...
	return &PetUserNameQuery{
		...
		eagerLoaders: cloneEagerLoadersPetUserName(_q.eagerLoaders),
	}
}
...
// dispatch loop.
func (_q *PetUserNameQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*PetUserName, error) {
	var (
		nodes = []*PetUserName{}
		_spec = _q.querySpec()
	)
...
func (_q *PetUserNameQuery) IncludeForeignKeys(bool) *PetUserNameQuery {
	return _q
}
...
func (_g *PetUserNameGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*PetUserNameQuery, *PetUserNameGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *PetUserNameSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*PetUserNameQuery, *PetUserNameSelect](ctx, _s.PetUserNameQuery, _s, _s.QueryState.Inters, v)
}
...
// cloneEagerLoadersPetUserName returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersPetUserName(in map[string]func(context.Context, []*PetUserName) error) map[string]func(context.Context, []*PetUserName) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*PetUserName) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out

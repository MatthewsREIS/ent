...
const (
	...
	// TypePetUserName holds the string denoting the petusername type in the database.
...
type PetUserName = internal.PetUserName
type PetUserNames = internal.PetUserNames

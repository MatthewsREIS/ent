...
func (e *StreetEdges) SetLoadedTypes(lt [1]bool) {
	e.loadedTypes = lt
}

// IsLoaded returns whether the edge at the given index was loaded.
func (e StreetEdges) IsLoaded(idx int) bool {
...
func (e StreetEdges) CityOrErr() (*City, error) {
	if e.City != nil {
		...
		return nil, &NotFoundError{Label: "City"}
	}
...
func (*Street) ScanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case "city_streets": // city_streets
			values[i] = new(sql.NullInt64)
		default:
...
// SetCityStreets sets the city_streets foreign key.
func (_m *Street) SetCityStreets(v int) {
	_m.city_streets = &v
}

// GetCityStreets returns the city_streets foreign key value.
func (_m *Street) GetCityStreets() *int {
	return _m.city_streets
}
...
func (_m *Street) Unwrap() *Street {
	...
	if !ok {
		panic("internal: Street is not a transactional entity")
	}

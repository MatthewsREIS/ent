...
const (
	...
	// TypeStreet holds the string denoting the street type in the database.
	TypeStreet = "Street"
)
...
type Street = internal.Street
type StreetEdges = internal.StreetEdges
type Streets = internal.Streets

...
// NewCityDelete returns a new CityDelete initialized with the given config, hooks, and mutation.
func NewCityDelete(c Config, hooks []Hook, mutation *CityMutation) *CityDelete {
	return &CityDelete{Config: c, hooks: hooks, mutation: mutation}
}
...
func (_d *CityDelete) Exec(ctx context.Context) (int, error) {
	return entbuilder.RunDelete(ctx, &entbuilder.DeleteState[*CityMutation]{Hooks: _d.hooks, Mutation: _d.mutation}, _d.sqlExec)
}
...
// NewCityDeleteOne returns a new CityDeleteOne wrapping the given CityDelete.
func NewCityDeleteOne(d *CityDelete) *CityDeleteOne {
	return &CityDeleteOne{_d: d}
}

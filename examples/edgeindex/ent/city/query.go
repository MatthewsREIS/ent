...
type CityQuery struct {
	Config
	entbuilder.QueryState[predicate.City]
	order        []OrderOption
	eagerLoaders map[string]func(context.Context, []*City) error
}
...
func (_q *CityQuery) StoreEager(name string, loader func(context.Context, []*City) error) *CityQuery {
	if _q.eagerLoaders == nil {
		_q.eagerLoaders = make(map[string]func(context.Context, []*City) error)
	}
...
func (_q *CityQuery) EagerLoaders() map[string]func(context.Context, []*City) error {
...
func (_q *CityQuery) Order(o ...OrderOption) *CityQuery {
...
func (_q *CityQuery) First(ctx context.Context) (*City, error) {
	_q.Limit(1)
	return entbuilder.RunFirst[*City, []*City](ctx, _q, _q.Ctx, ent.OpQueryFirst, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*City, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} })
}
...
func (_q *CityQuery) Only(ctx context.Context) (*City, error) {
	_q.Limit(2)
	return entbuilder.RunOnly[*City, []*City](ctx, _q, _q.Ctx, ent.OpQueryOnly, Label, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*City, error) { return _q.sqlAll(ctx) }, func(label string) error { return &NotFoundError{Label: label} }, func(label string) error { return &NotSingularError{Label: label} })
}
...
func (_q *CityQuery) All(ctx context.Context) ([]*City, error) {
	return entbuilder.RunAll[[]*City](ctx, _q, _q.Ctx, ent.OpQueryAll, _q.QueryState.Inters, _q.prepareQuery, func(ctx context.Context) ([]*City, error) { return _q.sqlAll(ctx) })
}
...
func (_q *CityQuery) Clone() *CityQuery {
	...
	return &CityQuery{
		...
		eagerLoaders: cloneEagerLoadersCity(_q.eagerLoaders),
	}
}
...
// dispatch loop.
func (_q *CityQuery) Fetch(ctx context.Context, hooks ...queryHook) ([]*City, error) {
	var (
		nodes       = []*City{}
		_spec       = _q.querySpec()
		loadedTypes = [1]bool{
			_q.eagerLoaders["streets"] != nil,
		}
	)
...
func (_q *CityQuery) IncludeForeignKeys(bool) *CityQuery {
	return _q
}
...
func (_g *CityGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*CityQuery, *CityGroupBy](ctx, _g.build, _g, _g.build.QueryState.Inters, v)
}
...
func (_s *CitySelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*CityQuery, *CitySelect](ctx, _s.CityQuery, _s, _s.QueryState.Inters, v)
}
...
// cityCreateDescriptor holds the metadata and callbacks for constructing a City entity.
var cityCreateDescriptor = &entbuilder.CreateDescriptor[Config, City, *CityMutation]{
	Table:   Table,
	NewNode: func(c Config) *City { return &City{Config: c} },
	ID: &entbuilder.IDDescriptor[Config, City, *CityMutation]{
		Column:      FieldID,
		Type:        field.TypeInt,
		UserDefined: false,
		AssignGenerated: func(n *City, v driver.Value) error {
			id, ok := v.(int64)
			if !ok {
				return fmt.Errorf("unexpected City.ID type: %T", v)
			}
			n.ID = int(id)
			return nil
		},
...
// cloneEagerLoadersCity returns a shallow copy of the eager-loaders map.
// The closures themselves are shared between original and clone.
func cloneEagerLoadersCity(in map[string]func(context.Context, []*City) error) map[string]func(context.Context, []*City) error {
	if in == nil {
		return nil
	}
	out := make(map[string]func(context.Context, []*City) error, len(in))
	for k, v := range in {
		out[k] = v
	}
	return out
